...
- **Skill Proficiencies.** [Deception](z_compendium/rules/skills.md#Deception), [Sleight of Hand](z_compendium/rules/skills.md#Sleight%20of%20Hand)  
- **Tool Proficiencies.** [Disguise kit](z_compendium/items/disguise-kit.md), [Forgery kit](z_compendium/items/forgery-kit.md)  
- **Equipment.** A set of [fine clothes](z_compendium/items/fine-clothes.md), a [disguise kit](z_compendium/items/disguise-kit.md), tools of the con of your choice (ten stoppered bottles filled with colored liquid, a set of weighted dice, a deck of marked cards, or a signet ring of an imaginary duke), and a belt [pouch](z_compendium/items/pouch.md) containing 15 gp  
