...
- **Skill Proficiencies.** [History](z_compendium/rules/skills.md#History), plus your choice of one from among [Arcana](z_compendium/rules/skills.md#Arcana), [Nature](z_compendium/rules/skills.md#Nature), and [Religion](z_compendium/rules/skills.md#Religion)  
- **Languages.** any two of your choice  
- **Equipment.** The scholar's [robes](z_compendium/items/robes.md) of your cloister, a writing kit (small [pouch](z_compendium/items/pouch.md) with a quill, ink, folded parchment, and a small penknife), a borrowed [book](z_compendium/items/book.md) on the subject of your current study, and a [pouch](z_compendium/items/pouch.md) containing 10 gp  
...
Use the tables for the [sage](z_compendium/backgrounds/sage.md) background in the Player's Handbook as the basis for your traits and motivations, modifying the entries when appropriate to suit your identity as a cloistered scholar.
