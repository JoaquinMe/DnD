...
- **Tool Proficiencies.** One type of gaming set, [thieves' tools](z_compendium/items/thieves-tools.md)  
- **Equipment.** A [crowbar](z_compendium/items/crowbar.md), a set of dark [common clothes](z_compendium/items/common-clothes.md) including a hood, and a belt [pouch](z_compendium/items/pouch.md) containing 15 gp  
