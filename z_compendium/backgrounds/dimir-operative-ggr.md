...
- **Skill Proficiencies.** [Deception](z_compendium/rules/skills.md#Deception), [Stealth](z_compendium/rules/skills.md#Stealth)  
- **Tool Proficiencies.** [Disguise kit](z_compendium/items/disguise-kit.md)  
- **Languages.** One of your choice  
- **Equipment.** A Dimir insignia, three small knives, a set of dark-colored [common clothes](z_compendium/items/common-clothes.md), and the starting equipment of the background described in this chapter for your secondary guild  
...
| Spell Level | Spells |
|-------------|--------|
| Cantrip | [encode thoughts](z_compendium/spells/encode-thoughts-ggr.md), [mage hand](z_compendium/spells/mage-hand.md) |
| 1st | [disguise self](z_compendium/spells/disguise-self.md), [sleep](z_compendium/spells/sleep.md) |
| 2nd | [detect thoughts](z_compendium/spells/detect-thoughts.md), [pass without trace](z_compendium/spells/pass-without-trace.md) |
| 3rd | [gaseous form](z_compendium/spells/gaseous-form.md), [meld into stone](z_compendium/spells/meld-into-stone.md), [nondetection](z_compendium/spells/nondetection.md) |
| 4th | [arcane eye](z_compendium/spells/arcane-eye.md), [freedom of movement](z_compendium/spells/freedom-of-movement.md) |
| 5th | [modify memory](z_compendium/spells/modify-memory.md) |
^dimir-guild-spells

Your magic is meant to be subtle and undetectable, but it might pull shadows or clouds of mist around you as you cast your spells. Using the [encode thoughts](z_compendium/spells/encode-thoughts-ggr.md) cantrip described below, you can turn a creature's thoughts (including your own) into a thought strand that others can potentially read, share, or steal. These thought strands are treated as valuable currency among the Dimir.
