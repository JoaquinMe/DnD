...
- **Tool Proficiencies.** One type of artisan's tools, or [navigator's tools](z_compendium/items/navigators-tools.md), or an additional language  
- **Languages.** One of your choice  
- **Equipment.** A set of artisan's tools (one of your choice) or a [mule](z_compendium/items/mule.md) and [cart](z_compendium/items/cart.md), a letter of introduction from your guild, a set of [traveler's clothes](z_compendium/items/travelers-clothes.md), and a belt [pouch](z_compendium/items/pouch.md) containing 15 gp  
