...
- **Skill Proficiencies.** Choose two from among [Arcana](z_compendium/rules/skills.md#Arcana), [Investigation](z_compendium/rules/skills.md#Investigation), [Religion](z_compendium/rules/skills.md#Religion), or [Survival](z_compendium/rules/skills.md#Survival)  
...
- **Equipment.** [Monster hunter's pack](z_compendium/items/monster-hunters-pack-vrgr.md) (containing a [chest](z_compendium/items/chest.md), a [crowbar](z_compendium/items/crowbar.md), a [hammer](z_compendium/items/hammer.md), three wooden stakes, a [holy symbol](z_compendium/items/holy-symbol.md), a [flask of holy water](z_compendium/items/holy-water-flask.md), a [set of manacles](z_compendium/items/manacles.md), a [steel mirror](z_compendium/items/steel-mirror.md), a [flask of oil](z_compendium/items/oil-flask.md), a [tinderbox](z_compendium/items/tinderbox.md), and 3 [torches](z_compendium/items/torch.md)), a set of [common clothes](z_compendium/items/common-clothes.md), one [trinket](z_compendium/items/trinket-cos.md) of special significance (choose one or roll on the [Horror Trinkets](z_compendium/items/horror-trinket-vrgr.md) table), and 1 sp  
