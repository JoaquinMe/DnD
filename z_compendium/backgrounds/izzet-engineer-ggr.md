...
- **Skill Proficiencies.** [Arcana](z_compendium/rules/skills.md#Arcana), [Investigation](z_compendium/rules/skills.md#Investigation)  
- **Tool Proficiencies.** One type of artisan's tools  
- **Languages.** Choose one of Draconic, Goblin, or Vedalken  
- **Equipment.** An Izzet insignia, one set of artisan's tools, the charred and twisted remains of a failed experiment, a [hammer](z_compendium/items/hammer.md), a [block and tackle](z_compendium/items/block-and-tackle.md), a set of [common clothes](z_compendium/items/common-clothes.md), and a belt [pouch](z_compendium/items/pouch.md) containing 5 gp (Azorius 1-zino coins)  
...
| Spell Level | Spells |
|-------------|--------|
| Cantrip | [produce flame](z_compendium/spells/produce-flame.md), [shocking grasp](z_compendium/spells/shocking-grasp.md) |
| 1st | [chaos bolt](z_compendium/spells/chaos-bolt-xge.md), [create or destroy water](z_compendium/spells/create-or-destroy-water.md), [unseen servant](z_compendium/spells/unseen-servant.md) |
| 2nd | [heat metal](z_compendium/spells/heat-metal.md), [rope trick](z_compendium/spells/rope-trick.md) |
| 3rd | [call lightning](z_compendium/spells/call-lightning.md), [elemental weapon](z_compendium/spells/elemental-weapon.md), [glyph of warding](z_compendium/spells/glyph-of-warding.md) |
| 4th | [conjure minor elementals](z_compendium/spells/conjure-minor-elementals.md), [divination](z_compendium/spells/divination.md), [Otiluke's resilient sphere](z_compendium/spells/otilukes-resilient-sphere.md) |
| 5th | [animate objects](z_compendium/spells/animate-objects.md), [conjure elemental](z_compendium/spells/conjure-elemental.md) |
^izzet-guild-spells

Your spells tend to be loud, flashy, or explosive, even when the effect is unremarkable. For example, when you open the portal of a [rope trick](z_compendium/spells/rope-trick.md) spell, the portal might be outlined by harmless, showy sparkles.

If you use an arcane focus, it probably takes the form of an intricate device that could include metal gauntlets, glass canisters, copper tubing, and leather straps attaching it to your body. The [mizzium apparatus](z_compendium/items/mizzium-apparatus-ggr.md) described in "chapter 5" is a magical version of this gear.

The [chaos bolt](z_compendium/spells/chaos-bolt-xge.md) spell is a favorite of Izzet spellcasters because of its unpredictable nature.
