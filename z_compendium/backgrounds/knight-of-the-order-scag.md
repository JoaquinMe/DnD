...
- **Skill Proficiencies.** [Persuasion](z_compendium/rules/skills.md#Persuasion), plus one from among [Arcana](z_compendium/rules/skills.md#Arcana), [History](z_compendium/rules/skills.md#History), [Nature](z_compendium/rules/skills.md#Nature), and [Religion](z_compendium/rules/skills.md#Religion), as appropriate for your order  
- **Tool Proficiencies.** Your choice of a gaming set or a musical instrument  
- **Languages.** Any one of your choice  
- **Equipment.** One set of [traveler's clothes](z_compendium/items/travelers-clothes.md), a signet, banner, or seal representing your place or rank in the order, and a [pouch](z_compendium/items/pouch.md) containing 10 gp  
...
Use the tables for the [soldier](z_compendium/backgrounds/soldier.md) background in the Player's Handbook as the basis for your traits and motivations, modifying the entries when appropriate to suit your identity as a knight of your order.
