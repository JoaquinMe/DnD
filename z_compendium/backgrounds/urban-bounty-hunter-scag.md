...
- **Skill Proficiencies.** Choose two from among [Deception](z_compendium/rules/skills.md#Deception), [Insight](z_compendium/rules/skills.md#Insight), [Persuasion](z_compendium/rules/skills.md#Persuasion), and [Stealth](z_compendium/rules/skills.md#Stealth)  
- **Tool Proficiencies.** Choose two from among one type of gaming set, one musical instrument, and [thieves' tools](z_compendium/items/thieves-tools.md)  
- **Equipment.** A set of clothes appropriate to your duties and a [pouch](z_compendium/items/pouch.md) containing 20 gp  
...
Use the tables for the [criminal](z_compendium/backgrounds/criminal.md) background in the Player's Handbook as the basis for your bounty hunter's traits and motivations, modifying the entries when appropriate to suit your identity as a bounty hunter.
