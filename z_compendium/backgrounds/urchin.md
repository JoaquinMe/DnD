...
- **Skill Proficiencies.** [Sleight of Hand](z_compendium/rules/skills.md#Sleight%20of%20Hand), [Stealth](z_compendium/rules/skills.md#Stealth)  
- **Tool Proficiencies.** [Disguise kit](z_compendium/items/disguise-kit.md), [Thieves' tools](z_compendium/items/thieves-tools.md)  
- **Equipment.** A small knife, a map of the city you grew up in, a pet mouse, a token to remember your parents by, a set of [common clothes](z_compendium/items/common-clothes.md), and a belt [pouch](z_compendium/items/pouch.md) containing 10 gp  
