...
- **Skill Proficiencies.** [History](z_compendium/rules/skills.md#History), [Persuasion](z_compendium/rules/skills.md#Persuasion)  
- **Languages.** Any one of your choice  
- **Tool Proficiencies.** One type of gaming set or musical instrument  
- **Equipment.** A set of [fine clothes](z_compendium/items/fine-clothes.md), a [signet ring](z_compendium/items/signet-ring.md) or brooch, a scroll of pedigree, a skin of fine zzar or wine, and a purse containing 20 gp  
...
Use the tables for the [noble](z_compendium/backgrounds/noble.md) background in the Player's Handbook as the basis for your traits and motivations, modifying the entries when appropriate to suit your identity as a member of a Waterdhavian family.
