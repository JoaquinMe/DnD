...
```ad-statblock
title: Derro Savant
![](z_compendium/bestiary/aberration/token/derro-savant.png#token)
...
***Sunlight Sensitivity.*** While in sunlight, the derro has disadvantage on attack rolls, as well as on Wisdom ([Perception](z_compendium/rules/skills.md#Perception)) checks that rely on sight.
...
**1/day each**: [invisibility](z_compendium/spells/invisibility.md), [sleep](z_compendium/spells/sleep.md), [spider climb](z_compendium/spells/spider-climb.md)
