...
```ad-statblock
title: Flumph
![](z_compendium/bestiary/aberration/token/flumph.png#token)
...
***Prone Deficiency.*** If the flumph is knocked [prone](z_compendium/rules/conditions.md#prone), roll a die. On an odd result, the flumph lands upside-down and is [incapacitated](z_compendium/rules/conditions.md#incapacitated). At the end of each of its turns, the flumph can make a DC 10 Dexterity saving throw, righting itself and ending the [incapacitated](z_compendium/rules/conditions.md#incapacitated) condition if it succeeds.
