...
```ad-statblock
title: Green Slaad
![](z_compendium/bestiary/aberration/token/green-slaad.png#token)
...
**At will**: [detect magic](z_compendium/spells/detect-magic.md), [detect thoughts](z_compendium/spells/detect-thoughts.md), [mage hand](z_compendium/spells/mage-hand.md)

**1/day**: [fireball](z_compendium/spells/fireball.md)

**2/day each**: [fear](z_compendium/spells/fear.md), [invisibility](z_compendium/spells/invisibility.md) (self only)
