...
```ad-statblock
title: Grell
![](z_compendium/bestiary/aberration/token/grell.png#token)
...
***Tentacles.*** *Melee Weapon Attack:* +4 to hit, reach 10 ft., one creature. *Hit:* 7 (`1d10 + 2`) piercing damage, and the target must succeed on a DC 11 Constitution saving throw or be [poisoned](z_compendium/rules/conditions.md#poisoned) for 1 minute. The [poisoned](z_compendium/rules/conditions.md#poisoned) target is [paralyzed](z_compendium/rules/conditions.md#paralyzed), and it can repeat the saving throw at the end of each of its turns, ending the effect on a success.

The target is also [grappled](z_compendium/rules/conditions.md#grappled) (escape DC 15). If the target is Medium or smaller, it is also [restrained](z_compendium/rules/conditions.md#restrained) until this grapple ends. While grappling the target, the grell has advantage on attack rolls against it and can 't use this attack against other targets. When the grell moves, any Medium or smaller target it is grappling moves with it.
