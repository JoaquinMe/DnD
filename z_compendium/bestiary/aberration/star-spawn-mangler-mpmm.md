...
![](z_compendium/bestiary/aberration/token/star-spawn-mangler.png#token)
...
***Shadow Stealth.*** While in dim light or darkness, the mangler takes the [Hide](z_compendium/rules/actions.md#Hide) action.
```
^statblock