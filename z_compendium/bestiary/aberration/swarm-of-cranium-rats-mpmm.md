...
![](z_compendium/bestiary/aberration/token/swarm-of-cranium-rats.png#token)
...
**At will**: [command](z_compendium/spells/command.md), [comprehend languages](z_compendium/spells/comprehend-languages.md), [detect thoughts](z_compendium/spells/detect-thoughts.md)

**1/day each**: [confusion](z_compendium/spells/confusion.md), [dominate monster](z_compendium/spells/dominate-monster.md)
