...
```ad-statblock
title: Ankylosaurus
![](z_compendium/bestiary/beast/token/ankylosaurus.png#token)
...
***Tail.*** *Melee Weapon Attack:* +7 to hit, reach 10 ft., one target. *Hit:* 18 (`4d6 + 4`) bludgeoning damage. If the target is a creature, it must succeed on a DC 14 Strength saving throw or be knocked [prone](z_compendium/rules/conditions.md#prone).
```
^statblock
