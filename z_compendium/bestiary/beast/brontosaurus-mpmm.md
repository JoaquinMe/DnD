...
```ad-statblock
title: Brontosaurus
![](z_compendium/bestiary/beast/token/brontosaurus.png#token)
...
***Stomp.*** *Melee Weapon Attack:* +8 to hit, reach 20 ft., one target. *Hit:* 27 (`5d8 + 5`) bludgeoning damage, and the target must succeed on a DC 14 Strength saving throw or be knocked [prone](z_compendium/rules/conditions.md#prone).
