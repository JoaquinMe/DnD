...
![](z_compendium/bestiary/beast/token/quetzalcoatlus.png#token)
...
***Flyby.*** The quetzalcoatlus doesn't provoke an [opportunity attack](z_compendium/rules/actions.md#opportunity%20attack) when it flies out of an enemy's reach.
