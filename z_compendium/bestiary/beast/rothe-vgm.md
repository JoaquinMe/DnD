...
Ordinary rothé resemble musk oxen and have [darkvision](z_compendium/rules/senses.md#darkvision) out to a range of 30 feet.

```ad-statblock
title: Rothé
![](z_compendium/bestiary/beast/token/rothe.png#token)
