...
![](z_compendium/bestiary/beast/token/tyrannosaurus-rex.png#token)
...
***Bite.*** *Melee Weapon Attack:* +10 to hit, reach 10 ft., one target. *Hit:* 33 (`4d12 + 7`) piercing damage. If the target is a Medium or smaller creature, it is [grappled](z_compendium/rules/conditions.md#grappled) (escape DC 17). Until this grapple ends, the target is [restrained](z_compendium/rules/conditions.md#restrained), and the tyrannosaurus can't bite another target.
