...
```ad-statblock
title: Animated Armor Detention Drone
![](z_compendium/bestiary/construct/token/animated-armor-detention-drone.png#token)
...
***Antimagic Susceptibility.*** The drone is [incapacitated](z_compendium/rules/conditions.md#incapacitated) while in the area of an [antimagic field](z_compendium/spells/antimagic-field.md). If targeted by [dispel magic](z_compendium/spells/dispel-magic.md), the drone must succeed on a Constitution saving throw against the caster's spell save DC or fall [unconscious](z_compendium/rules/conditions.md#unconscious) for 1 minute.

***False Appearance.*** While the drone remains motionless, it is indistinguishable from a normal suit of drone.

## Actions

***Multiattack.*** The drone makes two melee attacks.
