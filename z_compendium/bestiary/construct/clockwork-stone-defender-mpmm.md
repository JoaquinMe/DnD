...
The thick plates of stone riveted onto a stone [defender](z_compendium/items/defender.md) give it substantial protection. Its chief role is as a bodyguard.
...
![](z_compendium/bestiary/construct/token/clockwork-stone-defender.png#token)
...
***Slam.*** *Melee Weapon Attack:* +6 to hit, reach 5 ft., one target. *Hit:* 11 (`2d6 + 4`) bludgeoning damage, and if the target is Large or smaller, it is knocked [prone](z_compendium/rules/conditions.md#prone).
