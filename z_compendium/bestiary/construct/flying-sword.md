...
---
# Flying Sword
*Source: Monster Manual p. 20, Curse of Strahd, The Book of Many Things. Available in the SRD and the Basic Rules.*  
...
```ad-statblock
title: Flying Sword
![](z_compendium/bestiary/construct/token/flying-sword.png#token)
...
***Antimagic Susceptibility.*** The sword is [incapacitated](z_compendium/rules/conditions.md#incapacitated) while in the area of an [antimagic field](z_compendium/spells/antimagic-field.md). If targeted by [dispel magic](z_compendium/spells/dispel-magic.md), the sword must succeed on a Constitution saving throw against the caster's spell save DC or fall [unconscious](z_compendium/rules/conditions.md#unconscious) for 1 minute.
