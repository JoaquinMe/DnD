...
![](z_compendium/bestiary/construct/token/helmed-horror-detention-drone.png#token)
...
***Spell Immunity.*** The drone is immune to three spells chosen by its creator. Typical immunities include [fireball](z_compendium/spells/fireball.md), [heat metal](z_compendium/spells/heat-metal.md), and [lightning bolt](z_compendium/spells/lightning-bolt.md).
