...
```ad-statblock
title: Scarecrow
![](z_compendium/bestiary/construct/token/scarecrow.png#token)
...
- **Condition Immunities** [charmed](z_compendium/rules/conditions.md#charmed), [exhaustion](z_compendium/rules/conditions.md#exhaustion), [frightened](z_compendium/rules/conditions.md#frightened), [paralyzed](z_compendium/rules/conditions.md#paralyzed), [poisoned](z_compendium/rules/conditions.md#poisoned), [unconscious](z_compendium/rules/conditions.md#unconscious)
...
***Claw.*** *Melee Weapon Attack:* +3 to hit, reach 5 ft., one target. *Hit:* 6 (`2d4 + 1`) slashing damage. If the target is a creature, it must succeed on a DC 11 Wisdom saving throw or be [frightened](z_compendium/rules/conditions.md#frightened) until the end of the scarecrow's next turn.

***Terrifying Glare.*** The scarecrow targets one creature it can see within 30 feet of it. If the target can see the scarecrow, the target must succeed on a DC 11 Wisdom saving throw or be magically [frightened](z_compendium/rules/conditions.md#frightened) until the end of the scarecrow's next turn. The [frightened](z_compendium/rules/conditions.md#frightened) target is [paralyzed](z_compendium/rules/conditions.md#paralyzed).
```
^statblock
