...
![](z_compendium/bestiary/dragon/token/ancient-copper-dragon.png#token)
...
***Wing Attack (Costs 2 Actions).*** The dragon beats its wings. Each creature within 15 feet of the dragon must succeed on a DC 23 Dexterity saving throw or take 15 (`2d6 + 8`) bludgeoning damage and be knocked [prone](z_compendium/rules/conditions.md#prone). The dragon can then fly up to half its flying speed.

![Copper Dragon](z_compendium/bestiary/legendary-group/copper-dragon.md)
```
^statblock
