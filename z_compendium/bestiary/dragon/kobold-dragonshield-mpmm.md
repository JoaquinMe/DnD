...
![](z_compendium/bestiary/dragon/token/kobold-dragonshield.png#token)
*Small dragon, Any alignment*

- **Armor Class** 15  ([leather](z_compendium/items/leather-armor.md), [shield](z_compendium/items/shield.md))
...
***Heart of the Dragon.*** If the kobold is [frightened](z_compendium/rules/conditions.md#frightened) or [paralyzed](z_compendium/rules/conditions.md#paralyzed) by an effect that allows a saving throw, it can repeat the save at the start of its turn to end the effect on itself and all kobolds within 30 feet of it. Any kobold that benefits from this trait (including the dragonshield) has advantage on its next attack roll.
