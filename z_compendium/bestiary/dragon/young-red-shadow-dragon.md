...
The dragon's proficiency bonus is doubled for its Dexterity ([Stealth](z_compendium/rules/skills.md#Stealth)) checks.
...
While in dim light or darkness, the dragon can take the [Hide](z_compendium/rules/actions.md#Hide) action as a bonus action.

### Sunlight Sensitivity

While in sunlight, the dragon has disadvantage on attack rolls, as well as on Wisdom ([Perception](z_compendium/rules/skills.md#Perception)) checks that rely on sight.
...
![](z_compendium/bestiary/dragon/token/young-red-shadow-dragon.png#token)
...
***Sunlight Sensitivity.*** While in sunlight, the dragon has disadvantage on attack rolls, as well as on Wisdom ([Perception](z_compendium/rules/skills.md#Perception)) checks that rely on sight.
...
***Shadow Breath (Recharge 5-6).*** The dragon exhales shadowy fire in a 30-foot cone. Each creature in that area must make a DC 18 Dexterity saving throw, taking 56 (`16d6`) necrotic damage on a failed save, or half as much damage on a successful one. A humanoid reduced to 0 hit points by this damage dies, and an undead [shadow](z_compendium/bestiary/undead/shadow.md) rises from its corpse and acts immediately after the dragon in the initiative count. The shadow is under the dragon's control.
```
^statblock
