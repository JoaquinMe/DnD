...
```ad-statblock
title: Dao
![](z_compendium/bestiary/elemental/token/dao.png#token)
...
***Sure-Footed.*** The dao has advantage on Strength and Dexterity saving throws made against effects that would knock it [prone](z_compendium/rules/conditions.md#prone).
...
**At will**: [detect evil and good](z_compendium/spells/detect-evil-and-good.md), [detect magic](z_compendium/spells/detect-magic.md), [stone shape](z_compendium/spells/stone-shape.md)

**1/day each**: [conjure elemental](z_compendium/spells/conjure-elemental.md) ([earth elemental](z_compendium/bestiary/elemental/earth-elemental.md) only), [gaseous form](z_compendium/spells/gaseous-form.md), [invisibility](z_compendium/spells/invisibility.md), [phantasmal killer](z_compendium/spells/phantasmal-killer.md), [plane shift](z_compendium/spells/plane-shift.md), [wall of stone](z_compendium/spells/wall-of-stone.md)

**3/day each**: [passwall](z_compendium/spells/passwall.md), [move earth](z_compendium/spells/move-earth.md), [tongues](z_compendium/spells/tongues.md)
...
***Maul.*** *Melee Weapon Attack:* +10 to hit, reach 5 ft., one target. *Hit:* 20 (`4d6 + 6`) bludgeoning damage. If the target is a Huge or smaller creature, it must succeed on a DC 18 Strength check or be knocked [prone](z_compendium/rules/conditions.md#prone).
```
^statblock
