...
```ad-statblock
title: Dust Mephit
![](z_compendium/bestiary/elemental/token/dust-mephit.png#token)
...
***Death Burst.*** When the mephit dies, it explodes in a burst of dust. Each creature within 5 feet of it must then succeed on a DC 10 Constitution saving throw or be [blinded](z_compendium/rules/conditions.md#blinded) for 1 minute. A [blinded](z_compendium/rules/conditions.md#blinded) creature can repeat the saving throw on each of its turns, ending the effect on itself on a success.

***Innate Spellcasting (1/Day).*** The mephit can innately cast [sleep](z_compendium/spells/sleep.md), requiring no material components. Its innate spellcasting ability is Charisma.

**At will**: [sleep](z_compendium/spells/sleep.md)
