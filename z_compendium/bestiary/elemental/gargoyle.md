...
---
# Gargoyle
*Source: Monster Manual p. 140, Curse of Strahd, The Book of Many Things. Available in the SRD and the Basic Rules.*  
...
```ad-statblock
title: Gargoyle
![](z_compendium/bestiary/elemental/token/gargoyle.png#token)
