...
---
# Marid
*Source: Monster Manual p. 146, The Book of Many Things*  
...
```ad-statblock
title: Marid
![](z_compendium/bestiary/elemental/token/marid.png#token)
...
**At will**: [create or destroy water](z_compendium/spells/create-or-destroy-water.md), [detect evil and good](z_compendium/spells/detect-evil-and-good.md), [detect magic](z_compendium/spells/detect-magic.md), [fog cloud](z_compendium/spells/fog-cloud.md), [purify food and drink](z_compendium/spells/purify-food-and-drink.md)

**1/day each**: [conjure elemental](z_compendium/spells/conjure-elemental.md) ([water elemental](z_compendium/bestiary/elemental/water-elemental.md) only), [control water](z_compendium/spells/control-water.md), [gaseous form](z_compendium/spells/gaseous-form.md), [invisibility](z_compendium/spells/invisibility.md), [plane shift](z_compendium/spells/plane-shift.md)

**3/day each**: [tongues](z_compendium/spells/tongues.md), [water breathing](z_compendium/spells/water-breathing.md), [water walk](z_compendium/spells/water-walk.md)
...
***Water Jet.*** The marid magically shoots water in a 60-foot line that is 5 feet wide. Each creature in that line must make a DC 16 Dexterity saving throw. On a failure, a target takes 21 (`6d6`) bludgeoning damage and, if it is Huge or smaller, is pushed up to 20 feet away from the marid and knocked [prone](z_compendium/rules/conditions.md#prone). On a success, a target takes half the bludgeoning damage, but is neither pushed nor knocked [prone](z_compendium/rules/conditions.md#prone).
```
^statblock
