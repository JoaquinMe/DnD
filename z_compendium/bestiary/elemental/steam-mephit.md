...
```ad-statblock
title: Steam Mephit
![](z_compendium/bestiary/elemental/token/steam-mephit.png#token)
...
***Innate Spellcasting (1/Day).*** The mephit can innately cast [blur](z_compendium/spells/blur.md), requiring no material components. Its innate spellcasting ability is Charisma.

**At will**: [blur](z_compendium/spells/blur.md)
