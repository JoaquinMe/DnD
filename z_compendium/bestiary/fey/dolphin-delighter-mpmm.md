...
![](z_compendium/bestiary/fey/token/dolphin-delighter.png#token)
...
***Dazzling Slam.*** *Melee Weapon Attack:* +4 to hit, reach 5 ft., one target. *Hit:* 5 (`1d6 + 2`) bludgeoning damage plus 7 (`2d6`) psychic damage, and the target is [blinded](z_compendium/rules/conditions.md#blinded) until the start of the dolphin's next turn.
