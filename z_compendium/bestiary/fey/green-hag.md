...
---
# Green Hag
*Source: Monster Manual p. 177, The Book of Many Things. Available in the SRD.*  
...
```ad-statblock
title: Green Hag
![](z_compendium/bestiary/fey/token/green-hag.png#token)
...
**At will**: [dancing lights](z_compendium/spells/dancing-lights.md), [minor illusion](z_compendium/spells/minor-illusion.md), [vicious mockery](z_compendium/spells/vicious-mockery.md)
...
***Invisible Passage.*** The hag magically turns [invisible](z_compendium/rules/conditions.md#invisible) until she attacks or casts a spell, or until her [concentration](z_compendium/rules/conditions.md#concentration) ends (as if concentrating on a spell). While [invisible](z_compendium/rules/conditions.md#invisible), she leaves no physical evidence of her passage, so she can be tracked only by magic. Any equipment she wears or carries is [invisible](z_compendium/rules/conditions.md#invisible) with her.

![Green Hag](z_compendium/bestiary/legendary-group/green-hag.md)
```
^statblock
