...
![](z_compendium/bestiary/fey/token/hobgoblin-devastator.png#token)
*Medium fey (goblinoid), Typically  Lawful Neutral*

- **Armor Class** 13  ([studded leather](z_compendium/items/studded-leather-armor.md))
...
**2/day each**: [fireball](z_compendium/spells/fireball.md), [fly](z_compendium/spells/fly.md), [fog cloud](z_compendium/spells/fog-cloud.md), [gust of wind](z_compendium/spells/gust-of-wind.md), [lightning bolt](z_compendium/spells/lightning-bolt.md)
...
***Devastating Bolt.*** *Ranged Spell Attack:* +5 to hit, range 60 ft., one target. *Hit:* 21 (`4d8 + 3`) force damage, and the target is knocked [prone](z_compendium/rules/conditions.md#prone).
```
^statblock
