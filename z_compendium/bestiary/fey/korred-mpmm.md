...
Korreds prefer to keep their own company but occasionally consort with creatures of elemental earth such as [galeb duhr](z_compendium/bestiary/elemental/galeb-duhr.md). They often gather with other korreds to perform ceremonial dances, beating out rhythms on stone with their hooves and clubs. In the depths of the Material Plane, korreds typically flee from other creatures, but they become aggressive when they feel insulted or are annoyed by the sounds of mining.
...
```ad-statblock
title: Korred
![](z_compendium/bestiary/fey/token/korred.png#token)
...
***Stone Camouflage.*** The korred has advantage on Dexterity ([Stealth](z_compendium/rules/skills.md#Stealth)) checks made to hide in rocky terrain.
...
**At will**: [commune with nature](z_compendium/spells/commune-with-nature.md) (as an action), [meld into stone](z_compendium/spells/meld-into-stone.md), [stone shape](z_compendium/spells/stone-shape.md)

**1/day**: [Otto's irresistible dance](z_compendium/spells/ottos-irresistible-dance.md)
