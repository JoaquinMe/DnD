...
```ad-statblock
title: Nilbog
![](z_compendium/bestiary/fey/token/nilbog.png#token)
...
***Nilbogism.*** Any creature that attempts to damage the nilbog must first succeed on a DC 12 Charisma saving throw or be [charmed](z_compendium/rules/conditions.md#charmed) until the end of the creature's next turn. A creature [charmed](z_compendium/rules/conditions.md#charmed) in this way must use its action praising the nilbog.
...
***Nimble Escape.*** The nilbog takes the [Disengage](z_compendium/rules/actions.md#Disengage) or [Hide](z_compendium/rules/actions.md#Hide) action.
