...
```ad-statblock
title: Pixie
![](z_compendium/bestiary/fey/token/pixie.png#token)
...
**1/day each**: [confusion](z_compendium/spells/confusion.md), [dancing lights](z_compendium/spells/dancing-lights.md), [detect evil and good](z_compendium/spells/detect-evil-and-good.md), [detect thoughts](z_compendium/spells/detect-thoughts.md), [dispel magic](z_compendium/spells/dispel-magic.md), [entangle](z_compendium/spells/entangle.md), [fly](z_compendium/spells/fly.md), [phantasmal force](z_compendium/spells/phantasmal-force.md), [polymorph](z_compendium/spells/polymorph.md), [sleep](z_compendium/spells/sleep.md)

## Actions

***Superior Invisibility.*** The pixie magically turns [invisible](z_compendium/rules/conditions.md#invisible) until its [concentration](z_compendium/rules/conditions.md#concentration) ends (as if concentrating on a spell). Any equipment the pixie wears or carries is [invisible](z_compendium/rules/conditions.md#invisible) with it.
```
^statblock
