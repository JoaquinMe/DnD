...
```ad-statblock
title: Sea Hag
![](z_compendium/bestiary/fey/token/sea-hag.png#token)
...
***Horrific Appearance.*** Any humanoid that starts its turn within 30 feet of the hag and can see the hag's true form must make a DC 11 Wisdom saving throw. On a failed save, the creature is [frightened](z_compendium/rules/conditions.md#frightened) for 1 minute. A creature can repeat the saving throw at the end of each of its turns, with disadvantage if the hag is within line of sight, ending the effect on itself on a success. If a creature's saving throw is successful or the effect ends for it, the creature is immune to the hag's Horrific Appearance for the next 24 hours.
...
***Death Glare.*** The hag targets one [frightened](z_compendium/rules/conditions.md#frightened) creature she can see within 30 feet of her. If the target can see the hag, it must succeed on a DC 11 Wisdom saving throw against this magic or drop to 0 hit points.
...
![Sea Hag](z_compendium/bestiary/legendary-group/sea-hag.md)
```
^statblock
