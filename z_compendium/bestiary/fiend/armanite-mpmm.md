...
```ad-statblock
title: Armanite
![](z_compendium/bestiary/fiend/token/armanite.png#token)
...
***Hooves.*** *Melee Weapon Attack:* +8 to hit, reach 5 ft., one target. *Hit:* 12 (`2d6 + 5`) bludgeoning damage. If the target is a Large or smaller creature, it must succeed on a DC 16 Strength saving throw or be knocked [prone](z_compendium/rules/conditions.md#prone).
