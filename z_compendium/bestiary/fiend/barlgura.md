...
```ad-statblock
title: Barlgura
![](z_compendium/bestiary/fiend/token/barlgura.png#token)
...
**1/day each**: [entangle](z_compendium/spells/entangle.md), [phantasmal force](z_compendium/spells/phantasmal-force.md)

**2/day each**: [disguise self](z_compendium/spells/disguise-self.md), [invisibility](z_compendium/spells/invisibility.md) (self only)
