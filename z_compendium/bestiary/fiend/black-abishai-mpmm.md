...
```ad-statblock
title: Black Abishai
![](z_compendium/bestiary/fiend/token/black-abishai.png#token)
...
***Creeping Darkness (Recharge 6).*** The abishai casts [darkness](z_compendium/spells/darkness.md) at a point within 120 feet of it, requiring no spell components or [concentration](z_compendium/rules/conditions.md#concentration). Wisdom is its spellcasting ability for this spell. While the spell persists, the abishai can move the area of darkness up to 60 feet as a bonus action.
...
***Shadow Stealth.*** While in dim light or darkness, the abishai takes the [Hide](z_compendium/rules/actions.md#Hide) action.
```
^statblock
