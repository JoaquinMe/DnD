...
```ad-statblock
title: Dybbuk
![](z_compendium/bestiary/fiend/token/dybbuk.png#token)
...
**At will**: [dimension door](z_compendium/spells/dimension-door.md)

**3/day**: [phantasmal force](z_compendium/spells/phantasmal-force.md)
