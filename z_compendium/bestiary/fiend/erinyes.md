...
> 
> Some erinyes carry a [rope of entanglement](z_compendium/items/rope-of-entanglement.md) (detailed in the Dungeon Master's Guide). When such an erinyes uses its Multiattack, the erinyes can use the rope in place of two of the attacks.
...
```ad-statblock
title: Erinyes
![](z_compendium/bestiary/fiend/token/erinyes.png#token)
...
***Longbow.*** *Ranged Weapon Attack:* +7 to hit, range 150/600 ft., one target. *Hit:* 7 (`1d8 + 3`) piercing damage plus 13 (`3d8`) poison damage, and the target must succeed on a DC 14 Constitution saving throw or be [poisoned](z_compendium/rules/conditions.md#poisoned). The poison lasts until it is removed by the [lesser restoration](z_compendium/spells/lesser-restoration.md) spell or similar magic.
