...
```ad-statblock
title: Flind
![](z_compendium/bestiary/fiend/token/flind.png#token)
...
***Aura of Blood Thirst.*** If the flind isn't [incapacitated](z_compendium/rules/conditions.md#incapacitated), any creature with the Rampage trait can make a Bite attack as a bonus action while within 10 feet of the flind.
...
***Flail of Paralysis.*** *Melee Weapon Attack:* +9 to hit, reach 10 ft., one target. *Hit:* 10 (`1d10 + 5`) bludgeoning damage, and the target must succeed on a DC 16 Constitution saving throw or be [paralyzed](z_compendium/rules/conditions.md#paralyzed) until the end of its next turn.
