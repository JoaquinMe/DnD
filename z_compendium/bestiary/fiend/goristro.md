...
```ad-statblock
title: Goristro
![](z_compendium/bestiary/fiend/token/goristro.png#token)
...
***Hoof.*** *Melee Weapon Attack:* +13 to hit, reach 5 ft., one target. *Hit:* 23 (`3d10 + 7`) bludgeoning damage. If the target is a creature, it must succeed on a DC 21 Strength saving throw or be knocked [prone](z_compendium/rules/conditions.md#prone).
