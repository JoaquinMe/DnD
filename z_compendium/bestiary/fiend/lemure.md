...
```ad-statblock
title: Lemure
![](z_compendium/bestiary/fiend/token/lemure.png#token)
...
***Hellish Rejuvenation.*** A lemure that dies in the Nine Hells comes back to life with all its hit points in `1d10` days unless it is killed by a good-aligned creature with a [bless](z_compendium/spells/bless.md) spell cast on that creature or its remains are sprinkled with holy water.
