...
```ad-statblock
title: Mezzoloth
![](z_compendium/bestiary/fiend/token/mezzoloth.png#token)
...
**1/day**: [cloudkill](z_compendium/spells/cloudkill.md)

**2/day each**: [darkness](z_compendium/spells/darkness.md), [dispel magic](z_compendium/spells/dispel-magic.md)
