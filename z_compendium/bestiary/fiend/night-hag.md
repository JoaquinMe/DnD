...
---
# Night Hag
*Source: Monster Manual p. 178, Curse of Strahd, The Book of Many Things. Available in the SRD.*  
...
> 
> 1st level (4 slots): [identify](z_compendium/spells/identify.md), [ray of sickness](z_compendium/spells/ray-of-sickness.md)  
> 2nd level (3 slots): [hold person](z_compendium/spells/hold-person.md), [locate object](z_compendium/spells/locate-object.md)  
> 3rd level (3 slots): [bestow curse](z_compendium/spells/bestow-curse.md), [counterspell](z_compendium/spells/counterspell.md), [lightning bolt](z_compendium/spells/lightning-bolt.md)  
> 4th level (3 slots): [phantasmal killer](z_compendium/spells/phantasmal-killer.md), [polymorph](z_compendium/spells/polymorph.md)  
> 5th level (2 slots): [contact other plane](z_compendium/spells/contact-other-plane.md), [scrying](z_compendium/spells/scrying.md)  
> 6th level (1 slot): [eyebite](z_compendium/spells/eyebite.md)  
> 
> For casting these spells, each hag is a 12th-level spellcaster that uses Intelligence as her spellcasting ability. The spell save DC is 12 + the hag's Intelligence modifier, and the spell attack bonus is 4 + the hag's Intelligence modifier.
> 
> **Hag Eye.** A hag coven can craft a magic item called a hag eye, which is made from a real eye coated in varnish and often fitted to a pendant or other wearable item. The hag eye is usually entrusted to a minion for safekeeping and transport. A hag in the coven can take an action to see what the hag eye sees if the hag eye is on the same plane of existence. A hag eye has AC 10, 1 hit point, and [darkvision](z_compendium/rules/senses.md#darkvision) with a radius of 60 feet. If it is destroyed, each coven member takes `3d10` psychic damage and is [blinded](z_compendium/rules/conditions.md#blinded) for 24 hours.
> 
> A hag coven can have only one hag eye at a time, and creating a new one requires all three members of the coven to perform a ritual. The ritual takes 1 hour, and the hags can't perform it while [blinded](z_compendium/rules/conditions.md#blinded). During the ritual, if the hags take any action other than performing the ritual, they must start over.
^hag-covens
...
```ad-statblock
title: Night Hag
![](z_compendium/bestiary/fiend/token/night-hag.png#token)
...
**At will**: [detect magic](z_compendium/spells/detect-magic.md), [magic missile](z_compendium/spells/magic-missile.md)

**2/day each**: [plane shift](z_compendium/spells/plane-shift.md) (self only), [ray of enfeeblement](z_compendium/spells/ray-of-enfeeblement.md), [sleep](z_compendium/spells/sleep.md)
...
***Nightmare Haunting (1/Day).*** While on the Ethereal Plane, the hag magically touches a sleeping humanoid on the Material Plane. A [protection from evil and good](z_compendium/spells/protection-from-evil-and-good.md) spell cast on the target prevents this contact, as does a magic circle. As long as the contact persists, the target has dreadful visions. If these visions last for at least 1 hour, the target gains no benefit from its rest, and its hit point maximum is reduced by 5 (`1d10`). If this effect reduces the target's hit point maximum to 0, the target dies, and if the target was evil, its soul is trapped in the hag's soul bag. The reduction to the target's hit point maximum lasts until removed by the  [greater restoration](z_compendium/spells/greater-restoration.md) spell or similar magic.

![Night Hag](z_compendium/bestiary/legendary-group/night-hag.md)
```
^statblock