...
Individually, nupperibos are weak, but they're rarely alone and can be dangerous when gathered into packs. Clouds of stinging insects, [stirges](z_compendium/bestiary/beast/stirge.md), and other vermin surround them in a terrifying, reeking sheath that torments any non-devil that draws near.
...
```ad-statblock
title: Nupperibo
![](z_compendium/bestiary/fiend/token/nupperibo.png#token)
