...
```ad-statblock
title: Pit Fiend
![](z_compendium/bestiary/fiend/token/pit-fiend.png#token)
...
***Fear Aura.*** Any creature hostile to the pit fiend that starts its turn within 20 feet of the pit fiend must make a DC 21 Wisdom saving throw, unless the pit fiend is [incapacitated](z_compendium/rules/conditions.md#incapacitated). On a failed save, the creature is [frightened](z_compendium/rules/conditions.md#frightened) until the start of its next turn. If a creature's saving throw is successful, the creature is immune to the pit fiend's Fear Aura for the next 24 hours.
...
**At will**: [detect magic](z_compendium/spells/detect-magic.md), [fireball](z_compendium/spells/fireball.md)

**3/day each**: [hold monster](z_compendium/spells/hold-monster.md), [wall of fire](z_compendium/spells/wall-of-fire.md)
