...
---
# Shadow Demon
*Source: Monster Manual p. 64, Curse of Strahd, The Book of Many Things*  
...
```ad-statblock
title: Shadow Demon
![](z_compendium/bestiary/fiend/token/shadow-demon.png#token)
...
- **Condition Immunities** [exhaustion](z_compendium/rules/conditions.md#exhaustion), [grappled](z_compendium/rules/conditions.md#grappled), [paralyzed](z_compendium/rules/conditions.md#paralyzed), [petrified](z_compendium/rules/conditions.md#petrified), [poisoned](z_compendium/rules/conditions.md#poisoned), [prone](z_compendium/rules/conditions.md#prone), [restrained](z_compendium/rules/conditions.md#restrained)
...
***Light Sensitivity.*** While in bright light, the demon has disadvantage on attack rolls, as well as on Wisdom ([Perception](z_compendium/rules/skills.md#Perception)) checks that rely on sight.
