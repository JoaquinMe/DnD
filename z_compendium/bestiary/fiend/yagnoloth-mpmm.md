...
```ad-statblock
title: Yagnoloth
![](z_compendium/bestiary/fiend/token/yagnoloth.png#token)
...
**At will**: [darkness](z_compendium/spells/darkness.md), [detect magic](z_compendium/spells/detect-magic.md), [dispel magic](z_compendium/spells/dispel-magic.md), [invisibility](z_compendium/spells/invisibility.md) (self only), [suggestion](z_compendium/spells/suggestion.md)
...
***Massive Arm.*** *Melee Weapon Attack:* +8 to hit, reach 15 ft., one target. *Hit:* 23 (`3d12 + 4`) force damage. If the target is a creature, it must succeed on a DC 16 Constitution saving throw or become [stunned](z_compendium/rules/conditions.md#stunned) until the end of the yagnoloth's next turn.
