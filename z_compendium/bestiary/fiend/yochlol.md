...
```ad-statblock
title: Yochlol
![](z_compendium/bestiary/fiend/token/yochlol.png#token)
...
**At will**: [detect thoughts](z_compendium/spells/detect-thoughts.md), [web](z_compendium/spells/web.md)
