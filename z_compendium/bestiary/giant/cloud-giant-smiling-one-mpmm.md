...
![](z_compendium/bestiary/giant/token/cloud-giant-smiling-one.png#token)
...
***Control Weather (8th-level Spell).*** The giant can cast the [control weather](z_compendium/spells/control-weather.md) spell, requiring no material components and using Charisma as the spellcasting ability.
...
**At will**: [detect magic](z_compendium/spells/detect-magic.md), [fog cloud](z_compendium/spells/fog-cloud.md), [light](z_compendium/spells/light.md), [minor illusion](z_compendium/spells/minor-illusion.md)

**1/day each**: [gaseous form](z_compendium/spells/gaseous-form.md), [major image](z_compendium/spells/major-image.md)

**3/day each**: [invisibility](z_compendium/spells/invisibility.md), [silent image](z_compendium/spells/silent-image.md), [suggestion](z_compendium/spells/suggestion.md), [tongues](z_compendium/spells/tongues.md)
