...
```ad-statblock
title: Cloud Giant
![](z_compendium/bestiary/giant/token/cloud-giant.png#token)
...
***Keen Smell.*** The giant has advantage on Wisdom ([Perception](z_compendium/rules/skills.md#Perception)) checks that rely on smell.
...
**1/day each**: [control weather](z_compendium/spells/control-weather.md), [gaseous form](z_compendium/spells/gaseous-form.md)

**3/day each**: [feather fall](z_compendium/spells/feather-fall.md), [fly](z_compendium/spells/fly.md), [misty step](z_compendium/spells/misty-step.md), [telekinesis](z_compendium/spells/telekinesis.md)
