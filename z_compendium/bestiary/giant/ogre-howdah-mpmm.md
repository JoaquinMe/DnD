...
The most unusual of the specialized ogres, the howdah carries a palisaded wooden fort on its back. The fort serves as a fighting platform for up to four Small people. Ogre howdahs are most often seen bearing bow- and spear-wielding [goblins](z_compendium/bestiary/humanoid/goblin.md) into battle, or perhaps [kobolds](z_compendium/bestiary/humanoid/kobold.md) or [deep gnomes](z_compendium/bestiary/humanoid/deep-gnome-svirfneblin.md), but they might also transport other Small folk.
...
```ad-statblock
title: Ogre Howdah
![](z_compendium/bestiary/giant/token/ogre-howdah.png#token)
*Large giant, Typically  Chaotic Evil*

- **Armor Class** 15  ([breastplate](z_compendium/items/breastplate.md), [shield](z_compendium/items/shield.md))
