...
```ad-statblock
title: Spirit Troll
![](z_compendium/bestiary/giant/token/spirit-troll.png#token)
...
***Bite.*** *Melee Weapon Attack:* +7 to hit, reach 5 ft., one creature. *Hit:* 19 (`3d10 + 3`) psychic damage, and the target must succeed on a DC 15 Wisdom saving throw or be [stunned](z_compendium/rules/conditions.md#stunned) for 1 minute. The [stunned](z_compendium/rules/conditions.md#stunned) target can repeat the saving throw at the end of each of its turns, ending the effect on itself on a success.
