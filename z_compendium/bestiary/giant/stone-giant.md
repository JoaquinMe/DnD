...
```ad-statblock
title: Stone Giant
![](z_compendium/bestiary/giant/token/stone-giant.png#token)
*Huge giant, Neutral*
...
***Rock.*** *Ranged Weapon Attack:* +9 to hit, range 60/240 ft., one target. *Hit:* 28 (`4d10 + 6`) bludgeoning damage. If the target is a creature, it must succeed on a DC 17 Strength saving throw or be knocked [prone](z_compendium/rules/conditions.md#prone).
