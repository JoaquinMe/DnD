...
```ad-statblock
title: Troll
![](z_compendium/bestiary/giant/token/troll.png#token)
...
***Keen Smell.*** The troll has advantage on Wisdom ([Perception](z_compendium/rules/skills.md#Perception)) checks that rely on smell.
