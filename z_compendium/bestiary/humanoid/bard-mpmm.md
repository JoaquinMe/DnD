...
Each bard is a master of at least one type of performance. You may choose a bard's main type, or you may roll on the Bard [Performance](z_compendium/rules/skills.md#Performance) Types table to determine it.
...
```ad-statblock
title: Bard
![](z_compendium/bestiary/humanoid/token/bard.png#token)
...
**1/day each**: [charm person](z_compendium/spells/charm-person.md), [invisibility](z_compendium/spells/invisibility.md), [sleep](z_compendium/spells/sleep.md)
