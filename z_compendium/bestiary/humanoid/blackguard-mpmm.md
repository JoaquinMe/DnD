...
```ad-statblock
title: Blackguard
![](z_compendium/bestiary/humanoid/token/blackguard.png#token)
...
**2/day each**: [command](z_compendium/spells/command.md), [dispel magic](z_compendium/spells/dispel-magic.md), [find steed](z_compendium/spells/find-steed.md)
...
***Dreadful Aspect (Recharges after a Short or Long Rest).*** Each enemy within 30 feet of the blackguard must succeed on a DC 13 Wisdom saving throw or be [frightened](z_compendium/rules/conditions.md#frightened) of the blackguard for 1 minute. If a [frightened](z_compendium/rules/conditions.md#frightened) target ends its turn more than 30 feet away from the blackguard, the target can repeat the saving throw, ending the effect on itself on a success.
...
***Blind.*** The target is [blinded](z_compendium/rules/conditions.md#blinded) for 1 minute. The [blinded](z_compendium/rules/conditions.md#blinded) target can repeat the save at the end of each of its turns, ending the effect on itself on a success.

***Shove.*** The target is pushed up to 10 feet away and knocked [prone](z_compendium/rules/conditions.md#prone).
```
^statblock
