...
```ad-statblock
title: Blindheim
![](z_compendium/bestiary/humanoid/token/blindheim.png#token)
...
***Radiant Blast.*** Radiant energy erupts from the blindheim's eyes in a 15-foot cone. Each creature in that area must succeed on a DC 12 Constitution saving throw or take 7 (`2d6`) radiant damage and be [blinded](z_compendium/rules/conditions.md#blinded) until the end of the blindheim's next turn. Creatures with the Sunlight Sensitivity trait have disadvantage on this saving throw.
```
^statblock