...
![](z_compendium/bestiary/humanoid/token/conjurer-wizard.png#token)
...
**1/day each**: [fly](z_compendium/spells/fly.md), [stinking cloud](z_compendium/spells/stinking-cloud.md), [web](z_compendium/spells/web.md)

**2/day each**: [fireball](z_compendium/spells/fireball.md), [mage armor](z_compendium/spells/mage-armor.md), [unseen servant](z_compendium/spells/unseen-servant.md)
...
***Summon Elemental (1/Day).*** The conjurer magically summons an [air elemental](z_compendium/bestiary/elemental/air-elemental.md), an [earth elemental](z_compendium/bestiary/elemental/earth-elemental.md), a [fire elemental](z_compendium/bestiary/elemental/fire-elemental.md), or a [water elemental](z_compendium/bestiary/elemental/water-elemental.md). The elemental appears in an unoccupied space within 60 feet of the conjurer, whom it obeys. It takes its turn immediately after the conjurer. It lasts for 1 hour, until it or the conjurer dies, or until the conjurer dismisses it as a bonus action.
```
^statblock
