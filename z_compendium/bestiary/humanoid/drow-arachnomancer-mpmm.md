...
![](z_compendium/bestiary/humanoid/token/drow-arachnomancer.png#token)
...
**At will**: [dancing lights](z_compendium/spells/dancing-lights.md), [mage hand](z_compendium/spells/mage-hand.md)

**1/day each**: [darkness](z_compendium/spells/darkness.md), [dispel magic](z_compendium/spells/dispel-magic.md), [etherealness](z_compendium/spells/etherealness.md), [faerie fire](z_compendium/spells/faerie-fire.md), [fly](z_compendium/spells/fly.md), [insect plague](z_compendium/spells/insect-plague.md), [invisibility](z_compendium/spells/invisibility.md)
...
***Web (Spider Form Only; (Recharge 5-6)).*** *Ranged Weapon Attack:* +8 to hit, range 30/60 ft., one target. *Hit:* The target is [restrained](z_compendium/rules/conditions.md#restrained) by webbing. As an action, the [restrained](z_compendium/rules/conditions.md#restrained) target can make a DC 15 Strength check, bursting the webbing on a success. The webbing can also be attacked and destroyed (AC 10; hp 5; vulnerability to fire damage; immunity to bludgeoning, poison, and psychic damage).
