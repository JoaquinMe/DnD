...
```ad-statblock
title: Drow Mage
![](z_compendium/bestiary/humanoid/token/drow-mage.png#token)
...
**Cantrips (at will)**: [mage hand](z_compendium/spells/mage-hand.md), [minor illusion](z_compendium/spells/minor-illusion.md), [poison spray](z_compendium/spells/poison-spray.md), [ray of frost](z_compendium/spells/ray-of-frost.md)

**1st level (4 slots)**: [mage armor](z_compendium/spells/mage-armor.md), [magic missile](z_compendium/spells/magic-missile.md), [shield](z_compendium/spells/shield.md), [witch bolt](z_compendium/spells/witch-bolt.md)

**2nd level (3 slots)**: [alter self](z_compendium/spells/alter-self.md), [misty step](z_compendium/spells/misty-step.md), [web](z_compendium/spells/web.md)

**3rd level (3 slots)**: [fly](z_compendium/spells/fly.md), [lightning bolt](z_compendium/spells/lightning-bolt.md)

**4th level (3 slots)**: [Evard's black tentacles](z_compendium/spells/evards-black-tentacles.md), [greater invisibility](z_compendium/spells/greater-invisibility.md)

**5th level (2 slots)**: [cloudkill](z_compendium/spells/cloudkill.md)
...
***Summon Demon (1/Day).*** The drow magically summons a [quasit](z_compendium/bestiary/fiend/quasit.md), or attempts to summon a [shadow demon](z_compendium/bestiary/fiend/shadow-demon.md) with a 50% chance chance of success. The summoned demon appears in an unoccupied space within 60 feet of its summoner, acts as an ally of its summoner, and can't summon other demons. It remains for 10 minutes, until it or its summoner dies, or until its summoner dismisses it as an action.
```
^statblock
