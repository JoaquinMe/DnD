...
![](z_compendium/bestiary/humanoid/token/drow-shadowblade.png#token)
*Medium humanoid (elf), Any alignment*

- **Armor Class** 17  ([studded leather](z_compendium/items/studded-leather-armor.md))
...
***Devil's Sight.*** Magical darkness doesn't impede the drow's [darkvision](z_compendium/rules/senses.md#darkvision).
...
**1/day each**: [faerie fire](z_compendium/spells/faerie-fire.md), [levitate](z_compendium/spells/levitate.md) (self only)
