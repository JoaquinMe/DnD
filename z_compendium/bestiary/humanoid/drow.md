...
---
# Drow
*Source: Monster Manual p. 128, The Book of Many Things. Available in the SRD.*  
...
```ad-statblock
title: Drow
![](z_compendium/bestiary/humanoid/token/drow.png#token)
...
**1/day each**: [darkness](z_compendium/spells/darkness.md), [faerie fire](z_compendium/spells/faerie-fire.md)

## Actions

***Shortsword.*** *Melee Weapon Attack:* +4 to hit, reach 5 ft., one target. *Hit:* 5 (`1d6 + 2`) piercing damage.

***Hand Crossbow.*** *Ranged Weapon Attack:* +4 to hit, range 30/120 ft., one target. *Hit:* 5 (`1d6 + 2`) piercing damage, and the target must succeed on a DC 13 Constitution saving throw or be [poisoned](z_compendium/rules/conditions.md#poisoned) for 1 hour. If the saving throw fails by 5 or more, the target is also [unconscious](z_compendium/rules/conditions.md#unconscious) while [poisoned](z_compendium/rules/conditions.md#poisoned) in this way. The target wakes up if it takes damage or if another creature takes an action to shake it awake.
```
^statblock
