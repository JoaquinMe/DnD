...
![](z_compendium/bestiary/humanoid/token/duergar-despot.png#token)
...
**At will**: [mage hand](z_compendium/spells/mage-hand.md), [minor illusion](z_compendium/spells/minor-illusion.md)

**1/day**: [stinking cloud](z_compendium/spells/stinking-cloud.md)
...
***Iron Fist.*** *Melee Weapon Attack:* +9 to hit, reach 5 ft., one target. *Hit:* 23 (`4d8 + 5`) bludgeoning damage. If the target is a Large or smaller creature, it must succeed on a DC 17 Strength saving throw or be pushed up to 30 feet away in a straight line and be knocked [prone](z_compendium/rules/conditions.md#prone).

***Stomping Foot.*** *Melee Weapon Attack:* +9 to hit, reach 5 ft., one target. *Hit:* 10 (`1d10 + 5`) bludgeoning damage, or 21 (`3d10 + 5`) to a [prone](z_compendium/rules/conditions.md#prone) target.
