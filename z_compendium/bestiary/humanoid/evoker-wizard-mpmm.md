...
```ad-statblock
title: Evoker Wizard
![](z_compendium/bestiary/humanoid/token/evoker-wizard.png#token)
...
**At will**: [light](z_compendium/spells/light.md), [mage hand](z_compendium/spells/mage-hand.md), [message](z_compendium/spells/message.md), [prestidigitation](z_compendium/spells/prestidigitation.md)

**1/day each**: [wall of ice](z_compendium/spells/wall-of-ice.md)

**2/day each**: [ice storm](z_compendium/spells/ice-storm.md), [lightning bolt](z_compendium/spells/lightning-bolt.md), [mage armor](z_compendium/spells/mage-armor.md)
