...
Militarized githyanki cultures assign ranks and responsibilities to citizens. Groups of ten warriors follow the commands of sarths ([githyanki warriors](z_compendium/bestiary/humanoid/githyanki-warrior.md)), while ten sarths obey the commands of a mighty kith'rak. These champions undergo torturous training and psionic testing until they can command the respect of their underlings.
...
![](z_compendium/bestiary/humanoid/token/githyanki-kithrak.png#token)
...
**3/day each**: [blur](z_compendium/spells/blur.md), [nondetection](z_compendium/spells/nondetection.md) (self only)
...
***Rally the Troops.*** The githyanki magically ends the [charmed](z_compendium/rules/conditions.md#charmed) and [frightened](z_compendium/rules/conditions.md#frightened) conditions on itself and each creature of its choice that it can see within 30 feet of it.
