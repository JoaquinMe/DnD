...
Supreme commanders lead armies, each one commanding ten kith'raks, who in turn lead the rest of their forces. Most supreme commanders ride [red dragons](z_compendium/bestiary/dragon/adult-red-dragon.md) into battle.
...
![](z_compendium/bestiary/humanoid/token/githyanki-supreme-commander.png#token)
...
**1/day each**: [Bigby's hand](z_compendium/spells/bigbys-hand.md), [mass suggestion](z_compendium/spells/mass-suggestion.md), [plane shift](z_compendium/spells/plane-shift.md), [telekinesis](z_compendium/spells/telekinesis.md)

**3/day each**: [levitate](z_compendium/spells/levitate.md) (self only), [nondetection](z_compendium/spells/nondetection.md) (self only)

## Actions

***Multiattack.*** The githyanki makes two Silver Greatsword attacks.

***Silver Greatsword.*** *Melee Weapon Attack:* +12 to hit, reach 5 ft., one target. *Hit:* 14 (`2d6 + 7`) slashing damage plus 17 (`5d6`) psychic damage. On a critical hit against a target in an astral body (as with the [astral projection](z_compendium/spells/astral-projection.md) spell), the githyanki can cut the silvery cord that tethers the target to its material body, instead of dealing damage.
