...
![](z_compendium/bestiary/humanoid/token/githyanki-warrior.png#token)
*Medium humanoid (gith), Lawful Evil*

- **Armor Class** 17  ([half plate armor](z_compendium/items/half-plate-armor.md))
- **Hit Points** 49 (`9d8 + 9`)
- **Speed** 30 ft.
...
**3/day each**: [jump](z_compendium/spells/jump.md), [misty step](z_compendium/spells/misty-step.md), [nondetection](z_compendium/spells/nondetection.md) (self only)
