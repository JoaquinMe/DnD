...
![](z_compendium/bestiary/humanoid/token/githzerai-anarch.png#token)
...
**1/day each**: [globe of invulnerability](z_compendium/spells/globe-of-invulnerability.md), [plane shift](z_compendium/spells/plane-shift.md), [wall of force](z_compendium/spells/wall-of-force.md)

**3/day each**: [see invisibility](z_compendium/spells/see-invisibility.md), [telekinesis](z_compendium/spells/telekinesis.md)
...
***Change Gravity (Costs 3 Actions).*** The githzerai casts the [reverse gravity](z_compendium/spells/reverse-gravity.md) spell, using Wisdom as the spellcasting ability. The spell has the normal effect, except that the githzerai can orient the area in any direction and creatures and objects fall toward the end of the area.

![Githzerai Anarch](z_compendium/bestiary/legendary-group/githzerai-anarch-mpmm.md)
```
^statblock