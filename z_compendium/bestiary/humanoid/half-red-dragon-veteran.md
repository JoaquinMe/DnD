...
The half-dragon gains [blindsight](z_compendium/rules/senses.md#blindsight) with a radius of 10 feet and [darkvision](z_compendium/rules/senses.md#darkvision) with a radius of 60 feet.

### Resistances

The half-dragon gains resistance to a type of damage based on its color.

![Resistances](z_compendium/tables/resistances.md)
...
![New Action: Breath Weapon](z_compendium/tables/new-action-breath-weapon.md)

### Sample Half-Dragon

Here the half-dragon template has been applied to a human [veteran](z_compendium/bestiary/humanoid/veteran.md) to create a half-red dragon veteran. [Splint armor](z_compendium/items/splint-armor.md) has been replaced with [plate](z_compendium/items/plate-armor.md).

## Statblock

```ad-statblock
title: Half-Red Dragon Veteran
![](z_compendium/bestiary/humanoid/token/half-red-dragon-veteran.png#token)
