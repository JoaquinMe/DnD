...
![](z_compendium/bestiary/humanoid/token/hobgoblin-captain.png#token)
...
***Martial Advantage.*** Once per turn, the hobgoblin can deal an extra 10 (`3d6`) damage to a creature it hits with a weapon attack if that creature is within 5 feet of an ally of the hobgoblin that isn't [incapacitated](z_compendium/rules/conditions.md#incapacitated).
