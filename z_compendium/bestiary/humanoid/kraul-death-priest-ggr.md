...
![](z_compendium/bestiary/humanoid/token/kraul-death-priest.png#token)
...
***Feed on Death.*** When a creature within 30 feet of the kraul drops to 0 hit points, the kraul or another creature of its choice within 30 feet of it gains 5 (`1d10`) temporary hit points, provided the kraul isn't [incapacitated](z_compendium/rules/conditions.md#incapacitated).

***Hive Mind.*** The kraul is immune to the [charmed](z_compendium/rules/conditions.md#charmed) and [frightened](z_compendium/rules/conditions.md#frightened) conditions while within 30 feet of at least one other kraul.

***Pack Tactics.*** The kraul has advantage on an attack roll against a creature if at least one of the kraul's allies is within 5 feet of the creature and the ally isn't [incapacitated](z_compendium/rules/conditions.md#incapacitated).
...
**At will**: [chill touch](z_compendium/spells/chill-touch.md), [poison spray](z_compendium/spells/poison-spray.md)

**1/day each**: [animate dead](z_compendium/spells/animate-dead.md), [blight](z_compendium/spells/blight.md), [vampiric touch](z_compendium/spells/vampiric-touch.md)

**3/day each**: [ray of enfeeblement](z_compendium/spells/ray-of-enfeeblement.md), [ray of sickness](z_compendium/spells/ray-of-sickness.md)
