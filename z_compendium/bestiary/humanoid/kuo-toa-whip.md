...
```ad-statblock
title: Kuo-toa Whip
![](z_compendium/bestiary/humanoid/token/kuo-toa-whip.png#token)
...
**1st level (3 slots)**: [bane](z_compendium/spells/bane.md), [shield of faith](z_compendium/spells/shield-of-faith.md)
...
***Pincer Staff.*** *Melee Weapon Attack:* +4 to hit, reach 10 ft., one target. *Hit:* 5 (`1d6 + 2`) piercing damage. If the target is a Medium or smaller creature, it is [grappled](z_compendium/rules/conditions.md#grappled) (escape DC 14). Until this grapple ends, the kuo-toa can't use its pincer staff on another target.
```
^statblock
