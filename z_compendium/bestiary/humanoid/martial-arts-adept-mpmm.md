...
![](z_compendium/bestiary/humanoid/token/martial-arts-adept.png#token)
...
- **1–2 Knock Down..** The target must succeed on a DC 13 Dexterity saving throw or be knocked [prone](z_compendium/rules/conditions.md#prone).  
