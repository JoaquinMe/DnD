...
```ad-statblock
title: Master Thief
![](z_compendium/bestiary/humanoid/token/master-thief.png#token)
...
***Evasion.*** If the thief is subjected to an effect that allows it to make a Dexterity saving throw to take only half damage, the thief instead takes no damage if it succeeds on the saving throw and only half damage if it fails, provided the thief isn't [incapacitated](z_compendium/rules/conditions.md#incapacitated).
...
***Cunning Action.*** The thief takes the [Dash](z_compendium/rules/actions.md#Dash), [Disengage](z_compendium/rules/actions.md#Disengage), or [Hide](z_compendium/rules/actions.md#Hide) action.
