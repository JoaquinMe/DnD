...
![](z_compendium/bestiary/humanoid/token/necromancer-wizard.png#token)
...
**1/day each**: [circle of death](z_compendium/spells/circle-of-death.md)

**2/day each**: [bestow curse](z_compendium/spells/bestow-curse.md), [dimension door](z_compendium/spells/dimension-door.md), [mage armor](z_compendium/spells/mage-armor.md), [web](z_compendium/spells/web.md)
