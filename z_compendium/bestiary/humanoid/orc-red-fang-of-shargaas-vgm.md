...
![](z_compendium/bestiary/humanoid/token/orc-red-fang-of-shargaas.png#token)
...
***Veil of Shargaas (Recharges after a Short or Long Rest).*** The orc casts [darkness](z_compendium/spells/darkness.md) without any components. Wisdom is its spellcasting ability.
```
^statblock
