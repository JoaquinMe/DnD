...
![](z_compendium/bestiary/humanoid/token/shadar-kai-shadow-dancer.png#token)
...
- **3–4 Grapple.** The target is [grappled](z_compendium/rules/conditions.md#grappled) (escape DC 14) if it is a Medium or smaller creature. Until the grapple ends, the target is [restrained](z_compendium/rules/conditions.md#restrained), and the shadar-kai can't grapple another target.  
- **5–6 Topple.** The target is knocked [prone](z_compendium/rules/conditions.md#prone).  
