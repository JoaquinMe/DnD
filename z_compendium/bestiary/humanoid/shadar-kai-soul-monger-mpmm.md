...
![](z_compendium/bestiary/humanoid/token/shadar-kai-soul-monger.png#token)
...
**1/day each**: [bestow curse](z_compendium/spells/bestow-curse.md), [finger of death](z_compendium/spells/finger-of-death.md), [gaseous form](z_compendium/spells/gaseous-form.md), [seeming](z_compendium/spells/seeming.md)
...
***Wave of Weariness (Recharge 4-6).*** The shadar-kai emits weariness in a 60-foot cube. Each creature in that area must make a DC 16 Constitution saving throw. On a failed save, a creature takes 45 (`10d8`) psychic damage and suffers 1 level of [exhaustion](z_compendium/rules/conditions.md#exhaustion). On a successful save, it takes half as much damage and doesn't gain a level of [exhaustion](z_compendium/rules/conditions.md#exhaustion).
```
^statblock
