...
```ad-statblock
title: Swashbuckler
![](z_compendium/bestiary/humanoid/token/swashbuckler.png#token)
*Medium humanoid, Any alignment*

- **Armor Class** 17  ([leather armor](z_compendium/items/leather-armor.md), suave defense)
...
***Suave Defense.*** While the swashbuckler is wearing light or no armor and wielding no [shield](z_compendium/items/shield.md), its AC includes its Charisma modifier.
...
***Lightfooted.*** The swashbuckler takes the [Dash](z_compendium/rules/actions.md#Dash) or [Disengage](z_compendium/rules/actions.md#Disengage) action.
```
^statblock
