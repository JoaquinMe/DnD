...
```ad-statblock
title: Vistana Spy
![](z_compendium/bestiary/humanoid/token/vistana-spy.png#token)
...
***Sneak Attack (1/Turn).*** The spy deals an extra 7 (`2d6`) damage when it hits a target with a weapon attack and has advantage on the attack roll, or when the target is within 5 feet of an ally of the spy that isn't [incapacitated](z_compendium/rules/conditions.md#incapacitated) and the spy doesn't have disadvantage on the attack roll.
...
***Curse (Recharges After a Long Rest).*** 13
...
***Evil Eye (Recharges after a Short or Long Rest).*** 13
