...
```ad-statblock
title: Warlord
![](z_compendium/bestiary/humanoid/token/warlord.png#token)
...
***Frighten Foe (Costs 2 Actions).*** The warlord targets one creature it can see within 30 feet of it. If the target can see and hear it, the target must succeed on a DC 16 Wisdom saving throw or be [frightened](z_compendium/rules/conditions.md#frightened) until the end of warlord's next turn.
```
^statblock
