...
```ad-statblock
title: Werebear
![](z_compendium/bestiary/humanoid/token/werebear.png#token)
...
***Keen Smell.*** The werebear has advantage on Wisdom ([Perception](z_compendium/rules/skills.md#Perception)) checks that rely on smell.
