...
```ad-statblock
title: Xvart Speaker
![](z_compendium/bestiary/humanoid/token/xvart-speaker.png#token)
...
***Overbearing Pack.*** The xvart has advantage on Strength (Athletics) checks to shove a creature if at least one of the xvart's allies is within 5 feet of the target and the ally isn't [incapacitated](z_compendium/rules/conditions.md#incapacitated).
