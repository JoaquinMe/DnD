...
- Beasts that have an Intelligence score of 2 or lower are [charmed](z_compendium/rules/conditions.md#charmed) by the hag and directed to be aggressive toward intruders in the area.  
...
- Small avalanches of snow intermittently fall, blocking a path or burying intruders. A buried creature is [restrained](z_compendium/rules/conditions.md#restrained) and has to hold its breath until it is dug out.  
