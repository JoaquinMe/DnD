...
- **Cast a Spell.** The morkoth casts [darkness](z_compendium/spells/darkness.md), [dispel magic](z_compendium/spells/dispel-magic.md), or [misty step](z_compendium/spells/misty-step.md), using Intelligence as its spellcasting ability and without expending a spell slot.  
