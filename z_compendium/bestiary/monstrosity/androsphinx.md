...
```ad-statblock
title: Androsphinx
![](z_compendium/bestiary/monstrosity/token/androsphinx.png#token)
...
**Cantrips (at will)**: [sacred flame](z_compendium/spells/sacred-flame.md), [spare the dying](z_compendium/spells/spare-the-dying.md), [thaumaturgy](z_compendium/spells/thaumaturgy.md)

**1st level (4 slots)**: [command](z_compendium/spells/command.md), [detect evil and good](z_compendium/spells/detect-evil-and-good.md), [detect magic](z_compendium/spells/detect-magic.md)

**2nd level (3 slots)**: [lesser restoration](z_compendium/spells/lesser-restoration.md), [zone of truth](z_compendium/spells/zone-of-truth.md)

**3rd level (3 slots)**: [dispel magic](z_compendium/spells/dispel-magic.md), [tongues](z_compendium/spells/tongues.md)
...
**5th level (2 slots)**: [flame strike](z_compendium/spells/flame-strike.md), [greater restoration](z_compendium/spells/greater-restoration.md)

**6th level (1 slots)**: [heroes' feast](z_compendium/spells/heroes-feast.md)
...
- **First Roar.** Each creature that fails a DC 18 Wisdom saving throw is [frightened](z_compendium/rules/conditions.md#frightened) for 1 minute. A [frightened](z_compendium/rules/conditions.md#frightened) creature can repeat the saving throw at the end of each of its turns, ending the effect on itself on a success.  
- **Second Roar.** Each creature that fails a DC 18 Wisdom saving throw is [deafened](z_compendium/rules/conditions.md#deafened) and [frightened](z_compendium/rules/conditions.md#frightened) for 1 minute. A [frightened](z_compendium/rules/conditions.md#frightened) creature is [paralyzed](z_compendium/rules/conditions.md#paralyzed) and can repeat the saving throw at the end of each of its turns, ending the effect on itself on a success.  
- **Third Roar.** Each creature makes a DC 18 Constitution saving throw. On a failed save, a creature takes 44 (`8d10`) thunder damage and is knocked [prone](z_compendium/rules/conditions.md#prone). On a successful save, the creature takes half as much damage and isn't knocked [prone](z_compendium/rules/conditions.md#prone).  
...
![Sphinx](z_compendium/bestiary/legendary-group/sphinx.md)
```
^statblock
