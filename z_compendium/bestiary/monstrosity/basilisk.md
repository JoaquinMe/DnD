...
Some alchemists are said to know how to process the basilisk's gullet and the fluids contained within. Properly handled, the gullet produces an oil that can return [petrified](z_compendium/rules/conditions.md#petrified) creatures to flesh and life. Unfortunately for such a victim, any parts lost in stone form remain absent if the creature revives. Revivification using the oil is impossible if a vital part of the [petrified](z_compendium/rules/conditions.md#petrified) creature, such as its head, is detached.
...
```ad-statblock
title: Basilisk
![](z_compendium/bestiary/monstrosity/token/basilisk.png#token)
