...
```ad-statblock
title: Darkmantle
![](z_compendium/bestiary/monstrosity/token/darkmantle.png#token)
...
***Echolocation.*** The darkmantle can't use its blindsight while [deafened](z_compendium/rules/conditions.md#deafened).
...
***Darkness Aura (1/Day).*** A 15-foot radius of magical darkness extends out from the darkmantle, moves with it, and spreads around corners. The darkness lasts as long as the darkmantle maintains [concentration](z_compendium/rules/conditions.md#concentration), up to 10 minutes (as if concentrating on a spell). Darkvision can't penetrate this darkness, and no natural light can illuminate it. If any of the darkness overlaps with an area of light created by a spell of 2nd level or lower, the spell creating the light is dispelled.
```
^statblock
