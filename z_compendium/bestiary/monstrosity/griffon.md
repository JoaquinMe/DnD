...
```ad-statblock
title: Griffon
![](z_compendium/bestiary/monstrosity/token/griffon.png#token)
...
***Keen Sight.*** The griffon has advantage on Wisdom ([Perception](z_compendium/rules/skills.md#Perception)) checks that rely on sight.
