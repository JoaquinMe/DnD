...
---
# Harpy
*Source: Monster Manual p. 181, The Book of Many Things. Available in the SRD and the Basic Rules.*  
...
```ad-statblock
title: Harpy
![](z_compendium/bestiary/monstrosity/token/harpy.png#token)
