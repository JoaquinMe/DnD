...
```ad-statblock
title: Hippogriff
![](z_compendium/bestiary/monstrosity/token/hippogriff.png#token)
...
***Keen Sight.*** The hippogriff has advantage on Wisdom ([Perception](z_compendium/rules/skills.md#Perception)) checks that rely on sight.
