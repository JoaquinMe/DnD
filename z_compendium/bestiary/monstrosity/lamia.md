...
Ruined desert cities and the tombs of forgotten monarchs make perfect lairs for the wicked lamias. These decadent monsters take what has been forgotten and make it the seat of their hedonistic rule, surrounding themselves with sycophants. Lamias rely on [jackalweres](z_compendium/bestiary/humanoid/jackalwere.md) to perform various tasks, sending them across the wastes to capture slaves or steal treasures from caravans, encampments, or villages, concealed by the lamia's magic as they attack.
...
Using its intoxicating touch, a lamia weakens the minds of its enemies, making them more susceptible to its enchantment spells and turning them into its slaves. Those it beguiles with [geas](z_compendium/spells/geas.md) spells are pitted against each other in elaborate contests for the lamia's amusement.

## Vain Predators

Always anxious to gain more wealth and slaves, a lamia uses a pool of water or a mirror in conjunction with a [scrying](z_compendium/spells/scrying.md) spell to view its domain. A lamia uses this power to watch over trade routes and nearby settlements, or to seek out objects and creatures it fancies.
...
```ad-statblock
title: Lamia
![](z_compendium/bestiary/monstrosity/token/lamia.png#token)
...
**At will**: [disguise self](z_compendium/spells/disguise-self.md) (any humanoid form), [major image](z_compendium/spells/major-image.md)

**1/day**: [geas](z_compendium/spells/geas.md)

**3/day each**: [charm person](z_compendium/spells/charm-person.md), [mirror image](z_compendium/spells/mirror-image.md), [scrying](z_compendium/spells/scrying.md), [suggestion](z_compendium/spells/suggestion.md)
