...
![](z_compendium/bestiary/monstrosity/token/lonely-sorrowsworn.png#token)
...
***Harpoon Arm.*** *Melee Weapon Attack:* +7 to hit, reach 60 ft., one target. *Hit:* 21 (`4d8 + 3`) piercing damage, and the target is [grappled](z_compendium/rules/conditions.md#grappled) (escape DC 15) if it is a Large or smaller creature. The sorrowsworn has two harpoon arms and can grapple up to two creatures at once.
