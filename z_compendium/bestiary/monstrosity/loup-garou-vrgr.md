...
```ad-statblock
title: Loup Garou
![](z_compendium/bestiary/monstrosity/token/loup-garou.png#token)
...
***Claws (Dire Wolf or Hybrid Form Only).*** *Melee Weapon Attack:* +9 to hit, reach 5 ft., one target. *Hit:* 11 (`2d6 + 4`) slashing damage. If the target is a creature, it must succeed on a DC 17 Strength saving throw or be knocked [prone](z_compendium/rules/conditions.md#prone).
