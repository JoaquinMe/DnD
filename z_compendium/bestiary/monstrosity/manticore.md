...
---
# Manticore
*Source: Monster Manual p. 213, The Book of Many Things. Available in the SRD and the Basic Rules.*  
...
```ad-statblock
title: Manticore
![](z_compendium/bestiary/monstrosity/token/manticore.png#token)
