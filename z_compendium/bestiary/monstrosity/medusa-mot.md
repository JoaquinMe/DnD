...
---
# Medusa
*Source: Mythic Odysseys of Theros p. 206, The Book of Many Things*  

```ad-statblock
title: Medusa
![](z_compendium/bestiary/monstrosity/token/medusa.png#token)
...
***Constrict.*** *Melee Weapon Attack:* +3 to hit, reach 10 ft., one target. *Hit:* 7 (`2d6`) bludgeoning damage, and the target is [grappled](z_compendium/rules/conditions.md#grappled) (escape DC 11). Until this grapple ends, the target is [restrained](z_compendium/rules/conditions.md#restrained), and the medusa can't constrict another target.
```
^statblock