...
---
# Mimic
*Source: Monster Manual p. 220, Curse of Strahd, The Book of Many Things. Available in the SRD.*  
...
```ad-statblock
title: Mimic
![](z_compendium/bestiary/monstrosity/token/mimic.png#token)
...
***Adhesive (Object Form Only).*** The mimic adheres to anything that touches it. A Huge or smaller creature adhered to the mimic is also [grappled](z_compendium/rules/conditions.md#grappled) by it (escape DC 13). Ability checks made to escape this grapple have disadvantage.

***False Appearance (Object Form Only).*** While the mimic remains motionless, it is indistinguishable from an ordinary object.

***Grappler.*** The mimic has advantage on attack rolls against any creature [grappled](z_compendium/rules/conditions.md#grappled) by it.
