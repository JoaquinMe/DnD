...
```ad-statblock
title: Nagpa
![](z_compendium/bestiary/monstrosity/token/nagpa.png#token)
...
**At will**: [detect magic](z_compendium/spells/detect-magic.md), [mage hand](z_compendium/spells/mage-hand.md), [message](z_compendium/spells/message.md), [minor illusion](z_compendium/spells/minor-illusion.md)

**1/day each**: [dominate person](z_compendium/spells/dominate-person.md), [etherealness](z_compendium/spells/etherealness.md), [feeblemind](z_compendium/spells/feeblemind.md)

**2/day each**: [fireball](z_compendium/spells/fireball.md), [fly](z_compendium/spells/fly.md), [hold person](z_compendium/spells/hold-person.md), [suggestion](z_compendium/spells/suggestion.md), [wall of fire](z_compendium/spells/wall-of-fire.md)
...
***Corruption.*** The nagpa targets one creature it can see within 90 feet of it. The target must make a DC 20 Charisma saving throw. An evil creature makes the save with disadvantage. On a failed save, the target is [charmed](z_compendium/rules/conditions.md#charmed) by the nagpa until the start of the nagpa's next turn. On a successful save, the target becomes immune to the nagpa's Corruption for the next 24 hours.

***Paralysis (Recharge 6-6).*** The nagpa forces each creature within 30 feet of it to make a DC 20 Wisdom saving throw, excluding Undead and Constructs. On a failed save, a target is [paralyzed](z_compendium/rules/conditions.md#paralyzed) for 1 minute. A [paralyzed](z_compendium/rules/conditions.md#paralyzed) target can repeat the saving throw at the end of each of its turns, ending the effect on itself on a success.
```
^statblock
