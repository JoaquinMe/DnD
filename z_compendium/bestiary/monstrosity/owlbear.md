...
---
# Owlbear
*Source: Monster Manual p. 249, The Book of Many Things. Available in the SRD and the Basic Rules.*  
...
```ad-statblock
title: Owlbear
![](z_compendium/bestiary/monstrosity/token/owlbear.png#token)
...
***Keen Sight and Smell.*** The owlbear has advantage on Wisdom ([Perception](z_compendium/rules/skills.md#Perception)) checks that rely on sight or smell.
