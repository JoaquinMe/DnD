...
```ad-statblock
title: Peryton
![](z_compendium/bestiary/monstrosity/token/peryton.png#token)
...
***Keen Sight and Smell.*** The peryton has advantage on Wisdom ([Perception](z_compendium/rules/skills.md#Perception)) checks that rely on sight or smell.
