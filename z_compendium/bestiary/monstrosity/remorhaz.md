...
---
# Remorhaz
*Source: Monster Manual p. 258, The Book of Many Things. Available in the SRD.*  
...
```ad-statblock
title: Remorhaz
![](z_compendium/bestiary/monstrosity/token/remorhaz.png#token)
...
***Bite.*** *Melee Weapon Attack:* +11 to hit, reach 10 ft., one target. *Hit:* 40 (`6d10 + 7`) piercing damage plus 10 (`3d6`) fire damage. If the target is a creature, it is [grappled](z_compendium/rules/conditions.md#grappled) (escape DC 17). Until this grapple ends, the target is [restrained](z_compendium/rules/conditions.md#restrained), and the remorhaz can't bite another target.
...
If the remorhaz takes 30 damage or more on a single turn from a creature inside it, the remorhaz must succeed on a DC 15 Constitution saving throw at the end of that turn or regurgitate all swallowed creatures, which fall [prone](z_compendium/rules/conditions.md#prone) in a space within 10 feet of the remorhaz. If the remorhaz dies, a swallowed creature is no longer [restrained](z_compendium/rules/conditions.md#restrained) by it and can escape from the corpse using 15 feet of movement, exiting [prone](z_compendium/rules/conditions.md#prone).
```
^statblock
