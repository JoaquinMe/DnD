...
Skulks are the soulless shells of travelers who became lost in the Shadowfell, wandering its gray wastes until they lost all sense of self. They are so devoid of identity that they have become permanently [invisible](z_compendium/rules/conditions.md#invisible). Only children can see a skulk without the help of a mirror or a special candle. On the rare occasions when a skulk is visible, it appears as a drab, featureless, hairless biped.
...
```ad-statblock
title: Skulk
![](z_compendium/bestiary/monstrosity/token/skulk.png#token)
...
***Fallible Invisibility.*** The skulk is [invisible](z_compendium/rules/conditions.md#invisible). This invisibility can be circumvented by three things:
