...
```ad-statblock
title: Spirit Naga
![](z_compendium/bestiary/monstrosity/token/spirit-naga.png#token)
...
**1st level (4 slots)**: [charm person](z_compendium/spells/charm-person.md), [detect magic](z_compendium/spells/detect-magic.md), [sleep](z_compendium/spells/sleep.md)

**2nd level (3 slots)**: [detect thoughts](z_compendium/spells/detect-thoughts.md), [hold person](z_compendium/spells/hold-person.md)

**3rd level (3 slots)**: [lightning bolt](z_compendium/spells/lightning-bolt.md), [water breathing](z_compendium/spells/water-breathing.md)

**4th level (3 slots)**: [blight](z_compendium/spells/blight.md), [dimension door](z_compendium/spells/dimension-door.md)

**5th level (2 slots)**: [dominate person](z_compendium/spells/dominate-person.md)
