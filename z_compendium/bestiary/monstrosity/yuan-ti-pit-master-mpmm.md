...
![](z_compendium/bestiary/monstrosity/token/yuan-ti-pit-master.png#token)
...
**At will**: [animal friendship](z_compendium/spells/animal-friendship.md) (snakes only), [guidance](z_compendium/spells/guidance.md), [mage hand](z_compendium/spells/mage-hand.md), [message](z_compendium/spells/message.md)

**2/day each**: [hold person](z_compendium/spells/hold-person.md), [invisibility](z_compendium/spells/invisibility.md)
...
***Merrshaulk's Slumber (1/Day).*** The yuan-ti targets up to five creatures that it can see within 60 feet of it. Each target must succeed on a DC 13 Constitution saving throw or fall into a magical sleep and be [unconscious](z_compendium/rules/conditions.md#unconscious) for 10 minutes. A sleeping target awakens if it takes damage or if someone uses an action to shake or slap it awake. This magical sleep has no effect on a creature immune to being [charmed](z_compendium/rules/conditions.md#charmed).
