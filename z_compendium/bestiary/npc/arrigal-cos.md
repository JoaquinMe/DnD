...
```ad-statblock
title: Arrigal
![](z_compendium/bestiary/npc/token/arrigal.png#token)
...
***Sneak Attack (1/Turn).*** Arrigal deals an extra 14 (`4d6`) damage when it hits a target with a weapon attack and has advantage on the attack roll, or when the target is within 5 feet of an ally of Arrigal that isn't [incapacitated](z_compendium/rules/conditions.md#incapacitated) and Arrigal doesn't have disadvantage on the attack roll.
