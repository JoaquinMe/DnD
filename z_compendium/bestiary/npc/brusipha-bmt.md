...
```ad-statblock
title: Brusipha
![](z_compendium/bestiary/npc/token/brusipha.png#token)
...
**At will**: [Prestidigitation](z_compendium/spells/prestidigitation.md), [Speak with Animals](z_compendium/spells/speak-with-animals.md)

**1/day each**: [Bestow Curse](z_compendium/spells/bestow-curse.md), [Command](z_compendium/spells/command.md), [Crown of Madness](z_compendium/spells/crown-of-madness.md)
...
***Unerring Tracker.*** Brusipha magically creates a psychic link with one creature she can see. For the next hour, Brusipha knows the current distance and direction to the target if it is on the same plane of existence. The link ends if Brusipha has the [incapacitated](z_compendium/rules/conditions.md#incapacitated) condition or uses this ability on a different target.
