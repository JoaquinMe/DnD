...
```ad-statblock
title: Demogorgon
![](z_compendium/bestiary/npc/token/demogorgon.png#token)
...
***Two Heads.*** Demogorgon has advantage on saving throws against being [blinded](z_compendium/rules/conditions.md#blinded), [deafened](z_compendium/rules/conditions.md#deafened), [stunned](z_compendium/rules/conditions.md#stunned), or knocked [unconscious](z_compendium/rules/conditions.md#unconscious).
...
**At will**: [detect magic](z_compendium/spells/detect-magic.md), [major image](z_compendium/spells/major-image.md)

**1/day each**: [feeblemind](z_compendium/spells/feeblemind.md), [project image](z_compendium/spells/project-image.md)

**3/day each**: [dispel magic](z_compendium/spells/dispel-magic.md), [fear](z_compendium/spells/fear.md), [telekinesis](z_compendium/spells/telekinesis.md)
...
- **1–2 Beguiling Gaze.** The target is [stunned](z_compendium/rules/conditions.md#stunned) until the start of Demogorgon's next turn or until Demogorgon is no longer within line of sight.  
- **3–4 Confusing Gaze.** The target suffers the effect of the [confusion](z_compendium/spells/confusion.md) spell without making a saving throw. The effect lasts until the start of Demogorgon's next turn. Demogorgon doesn't need to concentrate on the spell.  
- **5–6 Hypnotic Gaze.** The target is [charmed](z_compendium/rules/conditions.md#charmed) by Demogorgon until the start of Demogorgon's next turn. Demogorgon chooses how the [charmed](z_compendium/rules/conditions.md#charmed) target uses its action, reaction, and movement.  
...
![Demogorgon](z_compendium/bestiary/legendary-group/demogorgon-mpmm.md)
```
^statblock