...
```ad-statblock
title: Escher
![](z_compendium/bestiary/npc/token/escher.png#token)
...
*Stake to the Heart.* Escher is destroyed if a piercing weapon made of wood is driven into its heart while it is [incapacitated](z_compendium/rules/conditions.md#incapacitated) in its resting place.
...
***Bite.*** *Melee Weapon Attack:* +6 to hit, reach 5 ft., one willing creature, or a creature that is [grappled](z_compendium/rules/conditions.md#grappled) by Escher, [incapacitated](z_compendium/rules/conditions.md#incapacitated), or [restrained](z_compendium/rules/conditions.md#restrained). *Hit:* 6 (`1d6 + 3`) piercing damage plus 7 (`2d6`) necrotic damage. The target's hit point maximum is reduced by an amount equal to the necrotic damage taken, and Escher regains hit points equal to that amount. The reduction lasts until the target finishes a long rest. The target dies if this effect reduces its hit point maximum to 0.
