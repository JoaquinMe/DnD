...
```ad-statblock
title: Juiblex
![](z_compendium/bestiary/npc/token/juiblex.png#token)
...
***Foul.*** Any creature other than an Ooze that starts its turn within 10 feet of Juiblex must succeed on a DC 21 Constitution saving throw or be [poisoned](z_compendium/rules/conditions.md#poisoned) until the start of the creature's next turn.
...
**3/day each**: [contagion](z_compendium/spells/contagion.md), [gaseous form](z_compendium/spells/gaseous-form.md)
