...
![](z_compendium/bestiary/npc/token/kiril-stoyanovich.png#token)
...
***Keen Hearing and Smell.*** Kiril has advantage on Wisdom ([Perception](z_compendium/rules/skills.md#Perception)) checks that rely on hearing or smell.
