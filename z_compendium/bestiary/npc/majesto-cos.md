...
```ad-statblock
title: Majesto
![](z_compendium/bestiary/npc/token/majesto.png#token)
...
***Invisibility.*** Majesto magically turns [invisible](z_compendium/rules/conditions.md#invisible) until it attacks, or until its [concentration](z_compendium/rules/conditions.md#concentration) ends (as if concentrating on a spell). Any equipment Majesto wears or carries is [invisible](z_compendium/rules/conditions.md#invisible) with it.
```
^statblock