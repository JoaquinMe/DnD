...
```ad-statblock
title: Oddlewin
![](z_compendium/bestiary/npc/token/oddlewin.png#token)
...
***Fortune Teller.*** Oddlewin can cast the [Augury](z_compendium/spells/augury.md) spell as a ritual, using cards as the material component.

***Nilbogism.*** Any creature that attempts to damage Oddlewin must first succeed on a DC 12 Charisma saving throw or have the [charmed](z_compendium/rules/conditions.md#charmed) condition until the end of the creature's next turn. The creature must use its action praising Oddlewin.
...
**At will**: [Mage Hand](z_compendium/spells/mage-hand.md), [Tasha's Hideous Laughter](z_compendium/spells/tashas-hideous-laughter.md)
