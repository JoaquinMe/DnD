...
```ad-statblock
title: Sangzor
![](z_compendium/bestiary/npc/token/sangzor.png#token)
...
***Sure-Footed.*** Sangzor has advantage on Strength and Dexterity saving throws made against effects that would knock it [prone](z_compendium/rules/conditions.md#prone).
