...
```ad-statblock
title: Savid
![](z_compendium/bestiary/npc/token/savid.png#token)
...
***Keen Hearing and Sight.*** Savid has advantage on Wisdom ([Perception](z_compendium/rules/skills.md#Perception)) checks that rely on hearing or sight.
