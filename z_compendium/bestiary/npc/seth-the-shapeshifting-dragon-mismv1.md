...
```ad-statblock
title: Seth the Shapeshifting Dragon
![](z_compendium/bestiary/npc/token/seth-the-shapeshifting-dragon.png#token)
...
- **Proficiency Bonus** +4
- **Saving Throws** Strength +7, Dexterity +11, Constitution +8
...
***Invisible in Water.*** Seth has the [invisible](z_compendium/rules/conditions.md#invisible) condition while fully immersed in water.
...
***Riptide Breath (Recharge 5-6).*** Seth exhales a torrent of frigid water in a 30-foot cone. Each creature in that area must make a DC 16 Constitution saving throw. On a failed save, the creature takes 36 (`8d8`) cold damage and has the [incapacitated](z_compendium/rules/conditions.md#incapacitated) condition until the end of its next turn. On a successful save, the creature takes half as much damage only.
