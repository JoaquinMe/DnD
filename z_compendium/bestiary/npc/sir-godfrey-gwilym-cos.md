...
![](z_compendium/bestiary/npc/token/sir-godfrey-gwilym.png#token)
...
**1st level (4 slots)**: [command](z_compendium/spells/command.md), [divine favor](z_compendium/spells/divine-favor.md), [thunderous smite](z_compendium/spells/thunderous-smite.md)

**2nd level (3 slots)**: [branding smite](z_compendium/spells/branding-smite.md), [magic weapon](z_compendium/spells/magic-weapon.md)

**3rd level (3 slots)**: [blinding smite](z_compendium/spells/blinding-smite.md), [dispel magic](z_compendium/spells/dispel-magic.md)

**4th level (2 slots)**: [staggering smite](z_compendium/spells/staggering-smite.md)
...
***Vengeful Glare.*** The knight targets one creature it can see within 30 feet of it and against which it has sworn vengeance. The target must make a DC 15 Wisdom saving throw. On a failure, the target is [paralyzed](z_compendium/rules/conditions.md#paralyzed) until the knight deals damage to it, or until the end of the knight's next turn. When the paralysis ends, the target is [frightened](z_compendium/rules/conditions.md#frightened) of the knight for 1 minute. The [frightened](z_compendium/rules/conditions.md#frightened) target can repeat the saving throw at the end of each of its turns, with disadvantage if it can see the knight, ending the [frightened](z_compendium/rules/conditions.md#frightened) condition on itself on a success.
```
^statblock