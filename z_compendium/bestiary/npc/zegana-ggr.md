...
```ad-statblock
title: Zegana
![](z_compendium/bestiary/npc/token/zegana.png#token)
...
**Cantrips (at will)**: [acid splash](z_compendium/spells/acid-splash.md), [druidcraft](z_compendium/spells/druidcraft.md), [ray of frost](z_compendium/spells/ray-of-frost.md), [shape water](z_compendium/spells/shape-water-xge.md)

**1st level (4 slots)**: [color spray](z_compendium/spells/color-spray.md), [expeditious retreat](z_compendium/spells/expeditious-retreat.md), [fog cloud](z_compendium/spells/fog-cloud.md), [shield](z_compendium/spells/shield.md)

**2nd level (3 slots)**: [enlarge/reduce](z_compendium/spells/enlarge-reduce.md), [gust of wind](z_compendium/spells/gust-of-wind.md)

**3rd level (3 slots)**: [counterspell](z_compendium/spells/counterspell.md), [fly](z_compendium/spells/fly.md), [slow](z_compendium/spells/slow.md)

**4th level (3 slots)**: [control water](z_compendium/spells/control-water.md), [ice storm](z_compendium/spells/ice-storm.md), [polymorph](z_compendium/spells/polymorph.md)

**5th level (2 slots)**: [conjure elemental](z_compendium/spells/conjure-elemental.md), [creation](z_compendium/spells/creation.md)

**6th level (1 slots)**: [move earth](z_compendium/spells/move-earth.md), [wall of ice](z_compendium/spells/wall-of-ice.md)

**7th level (1 slots)**: [prismatic spray](z_compendium/spells/prismatic-spray.md), [teleport](z_compendium/spells/teleport.md)

**8th level (1 slots)**: [control weather](z_compendium/spells/control-weather.md), [dominate monster](z_compendium/spells/dominate-monster.md)
...
***Deluge (Recharge 4-6).*** Zegana conjures a wave of water that crashes down on an area within 120 feet of her. The area can be up to 30 feet long, up to 10 feet wide, and up to 10 feet tall. Each creature in that area must make a DC 18 Dexterity saving throw. On a failed save, a creature takes 18 (`4d8`) bludgeoning damage and is knocked [prone](z_compendium/rules/conditions.md#prone). On a successful save, a creature takes half as much damage and isn't knocked [prone](z_compendium/rules/conditions.md#prone). The water spreads out across the ground, extinguishing unprotected flames it comes in contact with, and then vanishes.
...
***Enlarge (Costs 2 Actions).*** Zegana casts [enlarge/reduce](z_compendium/spells/enlarge-reduce.md) on herself, using the enlarge option, without expending a spell slot.
