...
```ad-statblock
title: Zuggtmoy
![](z_compendium/bestiary/npc/token/zuggtmoy.png#token)
...
**At will**: [detect magic](z_compendium/spells/detect-magic.md), [locate animals or plants](z_compendium/spells/locate-animals-or-plants.md)

**1/day each**: [etherealness](z_compendium/spells/etherealness.md), [teleport](z_compendium/spells/teleport.md)

**3/day each**: [dispel magic](z_compendium/spells/dispel-magic.md), [entangle](z_compendium/spells/entangle.md), [plant growth](z_compendium/spells/plant-growth.md)
...
***Protective Thrall.*** When Zuggtmoy is hit by an attack roll, one creature within 10 feet of her that is [charmed](z_compendium/rules/conditions.md#charmed) by her is hit by the attack instead.

## Legendary Actions

***Attack.*** Zuggtmoy makes one Pseudopod attack.

***Exert Will.*** One creature [charmed](z_compendium/rules/conditions.md#charmed) by Zuggtmoy that she can see must use its reaction, if a available, to move up to its speed as she directs or to make one weapon attack against a target that she designates.

![Zuggtmoy](z_compendium/bestiary/legendary-group/zuggtmoy-mpmm.md)
```
^statblock