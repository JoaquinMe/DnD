...
```ad-statblock
title: Myconid Adult
![](z_compendium/bestiary/plant/token/myconid-adult.png#token)
...
***Pacifying Spores (3/Day).*** The myconid ejects spores at one creature it can see within 5 feet of it. The target must succeed on a DC 11 Constitution saving throw or be [stunned](z_compendium/rules/conditions.md#stunned) for 1 minute. The target can repeat the saving throw at the end of each of its turns, ending the effect on itself on a success.
