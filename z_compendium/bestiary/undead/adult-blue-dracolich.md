...
The dracolich can't be [charmed](z_compendium/rules/conditions.md#charmed), [frightened](z_compendium/rules/conditions.md#frightened), [paralyzed](z_compendium/rules/conditions.md#paralyzed), or [poisoned](z_compendium/rules/conditions.md#poisoned). It also doesn't suffer from [exhaustion](z_compendium/rules/conditions.md#exhaustion).
...
![](z_compendium/bestiary/undead/token/adult-blue-dracolich.png#token)
