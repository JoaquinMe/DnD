...
---
# Death Knight
*Source: Monster Manual p. 47, The Book of Many Things*  
...
```ad-statblock
title: Death Knight
![](z_compendium/bestiary/undead/token/death-knight.png#token)
...
***Marshal Undead.*** Unless the death knight is [incapacitated](z_compendium/rules/conditions.md#incapacitated), it and undead creatures of its choice within 60 feet of it have advantage on saving throws against features that turn undead.
...
**1st level (4 slots)**: [command](z_compendium/spells/command.md), [compelled duel](z_compendium/spells/compelled-duel.md), [searing smite](z_compendium/spells/searing-smite.md)

**2nd level (3 slots)**: [hold person](z_compendium/spells/hold-person.md), [magic weapon](z_compendium/spells/magic-weapon.md)

**3rd level (3 slots)**: [dispel magic](z_compendium/spells/dispel-magic.md), [elemental weapon](z_compendium/spells/elemental-weapon.md)

**4th level (3 slots)**: [banishment](z_compendium/spells/banishment.md), [staggering smite](z_compendium/spells/staggering-smite.md)

**5th level (2 slots)**: [destructive wave](z_compendium/spells/destructive-wave.md) (necrotic)
