...
![](z_compendium/bestiary/undead/token/deathlock-wight.png#token)
...
***Sunlight Sensitivity.*** While in sunlight, the deathlock has disadvantage on attack rolls, as well as on Wisdom ([Perception](z_compendium/rules/skills.md#Perception)) checks that rely on sight.
...
**At will**: [detect magic](z_compendium/spells/detect-magic.md), [disguise self](z_compendium/spells/disguise-self.md), [mage armor](z_compendium/spells/mage-armor.md)

**1/day each**: [fear](z_compendium/spells/fear.md), [hold person](z_compendium/spells/hold-person.md)
...
A Humanoid slain by this attack rises 24 hours later as a [zombie](z_compendium/bestiary/undead/zombie.md) under the deathlock's control, unless the Humanoid is restored to life or its body is destroyed. The deathlock can have no more than twelve zombies under its control at one time.
