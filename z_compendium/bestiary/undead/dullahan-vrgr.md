...
```ad-statblock
title: Dullahan
![](z_compendium/bestiary/undead/token/dullahan.png#token)
...
***Frightful Presence (Costs 2 Actions).*** Each creature of the dullahan's choice within 30 feet of it must succeed on a DC 15 Wisdom saving throw or become [frightened](z_compendium/rules/conditions.md#frightened) of the dullahan until the end of its next turn.
