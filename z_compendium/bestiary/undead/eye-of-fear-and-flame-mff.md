...
![](z_compendium/bestiary/undead/token/eye-of-fear-and-flame.png#token)
...
**At will**: [detect evil and good](z_compendium/spells/detect-evil-and-good.md), [detect thoughts](z_compendium/spells/detect-thoughts.md)

**1/day each**: [etherealness](z_compendium/spells/etherealness.md), [true seeing](z_compendium/spells/true-seeing.md)
...
- **Eye of Fear.** The target and up to four other creatures of the eye of fear and flame's choice within 10 feet of the target must each succeed on a DC 16 Wisdom saving throw or be [frightened](z_compendium/rules/conditions.md#frightened) for 1 minute. An affected creature can repeat the saving throw at the end of each of its turns, ending the effect on itself on a success.  
