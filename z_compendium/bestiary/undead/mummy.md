...
---
# Mummy
*Source: Monster Manual p. 228, The Book of Many Things. Available in the SRD and the Basic Rules.*  
...
```ad-statblock
title: Mummy
![](z_compendium/bestiary/undead/token/mummy.png#token)
...
- **Condition Immunities** [charmed](z_compendium/rules/conditions.md#charmed), [exhaustion](z_compendium/rules/conditions.md#exhaustion), [frightened](z_compendium/rules/conditions.md#frightened), [paralyzed](z_compendium/rules/conditions.md#paralyzed), [poisoned](z_compendium/rules/conditions.md#poisoned)
