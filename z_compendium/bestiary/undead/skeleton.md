...
---
# Skeleton
*Source: Monster Manual p. 272, Curse of Strahd, The Book of Many Things. Available in the SRD and the Basic Rules.*  
...
```ad-statblock
title: Skeleton
![](z_compendium/bestiary/undead/token/skeleton.png#token)
