...
```ad-statblock
title: Skull Lord
![](z_compendium/bestiary/undead/token/skull-lord.png#token)
...
***Evasion.*** If the skull lord is subjected to an effect that allows it to make a Dexterity saving throw to take only half the damage, the skull lord instead takes no damage if it succeeds on the saving throw and only half damage if it fails, provided it isn't [incapacitated](z_compendium/rules/conditions.md#incapacitated).
...
**At will**: [mage hand](z_compendium/spells/mage-hand.md), [message](z_compendium/spells/message.md)

**1/day each**: [cloudkill](z_compendium/spells/cloudkill.md), [cone of cold](z_compendium/spells/cone-of-cold.md)

**2/day each**: [dimension door](z_compendium/spells/dimension-door.md), [fear](z_compendium/spells/fear.md)
