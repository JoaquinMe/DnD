...
---
# Specter
*Source: Monster Manual p. 279, Curse of Strahd, The Book of Many Things. Available in the SRD.*  
...
```ad-statblock
title: Specter
![](z_compendium/bestiary/undead/token/specter.png#token)
...
***Sunlight Sensitivity.*** While in sunlight, the specter has disadvantage on attack rolls, as well as on Wisdom ([Perception](z_compendium/rules/skills.md#Perception)) checks that rely on sight.
