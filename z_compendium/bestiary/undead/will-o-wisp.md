...
---
# Will-o'-Wisp
*Source: Monster Manual p. 301, Curse of Strahd, The Book of Many Things. Available in the SRD.*  
...
```ad-statblock
title: Will-o'-Wisp
![](z_compendium/bestiary/undead/token/will-o-wisp.png#token)
...
***Invisibility.*** The will-o'-wisp and its light magically become [invisible](z_compendium/rules/conditions.md#invisible) until it attacks or uses its Consume Life, or until its [concentration](z_compendium/rules/conditions.md#concentration) ends (as if concentrating on a spell).
```
^statblock
