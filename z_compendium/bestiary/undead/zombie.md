...
---
# Zombie
*Source: Monster Manual p. 316, Curse of Strahd, The Book of Many Things. Available in the SRD and the Basic Rules.*  
...
```ad-statblock
title: Zombie
![](z_compendium/bestiary/undead/token/zombie.png#token)
