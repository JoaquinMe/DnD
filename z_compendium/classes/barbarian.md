...
- (a) a [greataxe](z_compendium/items/greataxe.md) or (b) any martial melee weapon  
- (a) two [handaxes](z_compendium/items/handaxe.md) or (b) any simple weapon  
- An [explorer's pack](z_compendium/items/explorers-pack.md), and four [javelins](z_compendium/items/javelin.md)  
...
- **Armor**: [shields](z_compendium/items/shield.md)
- **Weapons**: simple, martial
- **Tools**: none
...
You can make a barbarian quickly by following these suggestions. First, put your highest ability score in Strength, followed by Constitution. Second, choose the [outlander](z_compendium/backgrounds/outlander.md) background.
...
Your rage lasts for 1 minute. It ends early if you are knocked [unconscious](z_compendium/rules/conditions.md#unconscious) or if your turn ends and you haven't attacked a hostile creature since your last turn or taken damage since then. You can also end your rage on your turn as a bonus action.
...
At 2nd level, you gain an uncanny sense of when things nearby aren't as they should be, giving you an edge when you dodge away from danger. You have advantage on Dexterity saving throws against effects that you can see, such as traps and spells. To gain this benefit, you can't be [blinded](z_compendium/rules/conditions.md#blinded), [deafened](z_compendium/rules/conditions.md#deafened), or [incapacitated](z_compendium/rules/conditions.md#incapacitated).
...
Additionally, if you are surprised at the beginning of combat and aren't [incapacitated](z_compendium/rules/conditions.md#incapacitated), you can act normally on your first turn, but only if you enter your rage before doing anything else on that turn.
...
Beginning at 15th level, your rage is so fierce that it ends early only if you fall [unconscious](z_compendium/rules/conditions.md#unconscious) or if you choose to end it.
