...
- **Tools**: three [musical instruments](z_compendium/items/musical-instrument.md) of your choice
...
- (a) a [rapier](z_compendium/items/rapier.md), (b) a [longsword](z_compendium/items/longsword.md), or (c) any simple weapon  
- (a) a [diplomat's pack](z_compendium/items/diplomats-pack.md) or (b) an [entertainer's pack](z_compendium/items/entertainers-pack.md)  
- (a) a [lute](z_compendium/items/lute.md) or (b) any other musical instrument  
- [Leather armor](z_compendium/items/leather-armor.md), and a [dagger](z_compendium/items/dagger.md)  
...
- **Armor**: light
- **Weapons**: none
- **Tools**: one [musical instrument](z_compendium/items/musical-instrument.md) of your choice
...
You can make a bard quickly by following these suggestions. First, Charisma should be your highest ability score, followed by Dexterity. Second, choose the [entertainer](z_compendium/backgrounds/entertainer.md) background. Third, choose the [dancing lights](z_compendium/spells/dancing-lights.md) and [vicious mockery](z_compendium/spells/vicious-mockery.md) cantrips, along with the following 1st-level spells: [charm person](z_compendium/spells/charm-person.md), [detect magic](z_compendium/spells/detect-magic.md), [healing word](z_compendium/spells/healing-word.md), and [thunderwave](z_compendium/spells/thunderwave.md).
...
| 2 | A mithral [horn](z_compendium/items/horn.md) made by elves |
| 3 | A zither made with drow spider silk |
| 4 | An orcish [drum](z_compendium/items/drum.md) |
...
| 6 | When you sat on your [lute](z_compendium/items/lute.md) by mistake during the final stanza of "Starlight Serenade" |
^embarrassment
...
For example, if you know the 1st-level spell [cure wounds](z_compendium/spells/cure-wounds.md) and have a 1st-level and a 2nd-level spell slot available, you can cast [cure wounds](z_compendium/spells/cure-wounds.md) using either slot.
...
You can use a [musical instrument](z_compendium/items/musical-instrument.md) as a spellcasting focus for your bard spells.
...
At 6th level, you gain the ability to use musical notes or words of power to disrupt mind-influencing effects. As an action, you can start a performance that lasts until the end of your next turn. During that time, you and any friendly creatures within 30 feet of you have advantage on saving throws against being [frightened](z_compendium/rules/conditions.md#frightened) or [charmed](z_compendium/rules/conditions.md#charmed). A creature must be able to hear you to gain this benefit. The performance ends early if you are [incapacitated](z_compendium/rules/conditions.md#incapacitated) or silenced or if you voluntarily end it (no action required).
