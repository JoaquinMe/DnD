...
| Cleric Level | Spells |
|--------------|--------|
| 1st | [command](z_compendium/spells/command.md), [heroism](z_compendium/spells/heroism.md) |
| 3rd | [hold person](z_compendium/spells/hold-person.md), [zone of truth](z_compendium/spells/zone-of-truth.md) |
| 5th | [mass healing word](z_compendium/spells/mass-healing-word.md), [slow](z_compendium/spells/slow.md) |
| 7th | [compulsion](z_compendium/spells/compulsion.md), [locate creature](z_compendium/spells/locate-creature.md) |
| 9th | [commune](z_compendium/spells/commune.md), [dominate person](z_compendium/spells/dominate-person.md) |
^order-domain-spells

### Bonus Proficiencies (Level 1)

When you choose this domain at 1st level, you gain proficiency with heavy armor. You also gain proficiency in the [Intimidation](z_compendium/rules/skills.md#Intimidation) or [Persuasion](z_compendium/rules/skills.md#Persuasion) skill (your choice).
...
As an action, you present your holy symbol, and each creature of your choice that can see or hear you within 30 feet of you must succeed on a Wisdom saving throw or be [charmed](z_compendium/rules/conditions.md#charmed) by you until the end of your next turn or until the [charmed](z_compendium/rules/conditions.md#charmed) creature takes any damage. You can also cause any of the [charmed](z_compendium/rules/conditions.md#charmed) creatures to drop what they are holding when they fail the saving throw.
