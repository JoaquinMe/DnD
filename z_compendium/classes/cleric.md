...
- (a) a [mace](z_compendium/items/mace.md) or (b) a [warhammer](z_compendium/items/warhammer.md) (if proficient)  
- (a) [scale mail](z_compendium/items/scale-mail.md), (b) [leather armor](z_compendium/items/leather-armor.md), or (c) [chain mail](z_compendium/items/chain-mail.md) (if proficient)  
...
- A [shield](z_compendium/items/shield.md) and a [holy symbol](z_compendium/items/holy-symbol.md)  
...
You can make a cleric quickly by following these suggestions. First, Wisdom should be your highest ability score, followed by Strength or Constitution. Second, choose the [acolyte](z_compendium/backgrounds/acolyte.md) background.
...
You can use a [holy symbol](z_compendium/items/holy-symbol.md) as a spellcasting focus for your cleric spells.
