...
- **Agile Parry**  
    ...
    If you make an unarmed strike as part of the [Attack](z_compendium/rules/actions.md#Attack) action on your turn and are holding a kensei weapon, you can use it to defend yourself if it is a melee weapon. You gain a +2 bonus to AC until the start of your next turn, while the weapon is in your hand and you aren't [incapacitated](z_compendium/rules/conditions.md#incapacitated).  
...
You gain proficiency with your choice of [calligrapher's supplies](z_compendium/items/calligraphers-supplies.md) or [painter's supplies](z_compendium/items/painters-supplies.md).
