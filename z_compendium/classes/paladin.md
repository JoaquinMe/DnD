...
- **Armor**: light, medium, heavy, [shields](z_compendium/items/shield.md)
...
- (a) a martial weapon and a [shield](z_compendium/items/shield.md) or (b) two martial weapons  
- (a) five [javelins](z_compendium/items/javelin.md) or (b) any simple melee weapon  
- (a) a [priest's pack](z_compendium/items/priests-pack.md) or (b) an [explorer's pack](z_compendium/items/explorers-pack.md)  
- [Chain mail](z_compendium/items/chain-mail.md) and a [holy symbol](z_compendium/items/holy-symbol.md)  
...
You can make a paladin quickly by following these suggestions. First, Strength should be your highest ability score, followed by Charisma. Second, choose the [noble](z_compendium/backgrounds/noble.md) background.
...
The presence of strong evil registers on your senses like a noxious odor, and powerful good rings like heavenly music in your ears. As an action, you can open your awareness to detect such forces. Until the end of your next turn, you know the location of any celestial, fiend, or undead within 60 feet of you that is not behind total cover. You know the type (celestial, fiend, or undead) of any being whose presence you sense, but not its identity (the vampire Count Strahd von Zarovich, for instance). Within the same radius, you also detect the presence of any place or object that has been consecrated or desecrated, as with the [hallow](z_compendium/spells/hallow.md) spell.
...
You can use a [holy symbol](z_compendium/items/holy-symbol.md) as a spellcasting focus for your paladin spells.
...
Starting at 10th level, you and friendly creatures within 10 feet of you can't be [frightened](z_compendium/rules/conditions.md#frightened) while you are conscious.
...
> ![Fighting Style, Paladin](z_compendium/optional-features/list-fighting-style-paladin.md#Fighting%20Style,%20Paladin)
