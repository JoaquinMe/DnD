...
- **Armor**: light, medium, [shields](z_compendium/items/shield.md)
...
- (a) [scale mail](z_compendium/items/scale-mail.md) or (b) [leather armor](z_compendium/items/leather-armor.md)  
- (a) two [shortswords](z_compendium/items/shortsword.md) or (b) two simple melee weapons  
...
- A [longbow](z_compendium/items/longbow.md) and a [quiver](z_compendium/items/quiver.md) of [20 arrows](z_compendium/items/arrows-20.md)  
...
You can make a ranger quickly by following these suggestions. First, make Dexterity your highest ability score, followed by Wisdom. (Some rangers who focus on two-weapon fighting make Strength higher than Dexterity.) Second, choose the [outlander](z_compendium/backgrounds/outlander.md) background.
...
Choose a type of favored enemy: aberrations, beasts, celestials, constructs, dragons, elementals, fey, fiends, giants, monstrosities, oozes, plants, or undead. Alternatively, you can select two races of humanoid (such as [gnolls](z_compendium/bestiary/humanoid/gnoll.md) and [orcs](z_compendium/bestiary/humanoid/orc.md)) as favored enemies.

You have advantage on Wisdom ([Survival](z_compendium/rules/skills.md#Survival)) checks to track your favored enemies, as well as on Intelligence checks to recall information about them.
...
For example, if you know the 1st-level spell [animal friendship](z_compendium/spells/animal-friendship.md) and have a 1st-level and a 2nd-level spell slot available, you can cast [animal friendship](z_compendium/spells/animal-friendship.md) using either slot.
...
In addition, you have advantage on saving throws against plants that are magically created or manipulated to impede movement, such as those created by the [entangle](z_compendium/spells/entangle.md) spell.

### Hide in Plain Sight (Level 10)

Starting at 10th level, you can spend 1 minute creating camouflage for yourself. You must have access to fresh mud, dirt, plants, soot, and other naturally occurring materials with which to create your camouflage.

Once you are camouflaged in this way, you can try to hide by pressing yourself up against a solid surface, such as a tree or wall, that is at least as tall and wide as you are. You gain a +10 bonus to Dexterity ([Stealth](z_compendium/rules/skills.md#Stealth)) checks as long as you remain there without moving or taking actions. Once you move or take an action or a reaction, you must camouflage yourself again to gain this benefit.
...
Starting at 14th level, you can use the [Hide](z_compendium/rules/actions.md#Hide) action as a bonus action on your turn. Also, you can't be tracked by nonmagical means, unless you choose to leave a trail.
...
At 18th level, you gain preternatural senses that help you fight creatures you can't see. When you attack a creature you can't see, your inability to see it doesn't impose disadvantage on your attack rolls against it. You are also aware of the location of any [invisible](z_compendium/rules/conditions.md#invisible) creature within 30 feet of you, provided that the creature isn't hidden from you and you aren't [blinded](z_compendium/rules/conditions.md#blinded) or [deafened](z_compendium/rules/conditions.md#deafened).
...
> ![Fighting Style, Ranger](z_compendium/optional-features/list-fighting-style-ranger.md#Fighting%20Style,%20Ranger)
