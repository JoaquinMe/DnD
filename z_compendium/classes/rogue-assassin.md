...
When you choose this archetype at 3rd level, you gain proficiency with the [disguise kit](z_compendium/items/disguise-kit.md) and the [poisoner's kit](z_compendium/items/poisoners-kit.md).
...
Your ruse is indiscernible to the casual observer. If a wary creature suspects something is amiss, you have advantage on any Charisma ([Deception](z_compendium/rules/skills.md#Deception)) check you make to avoid detection.
