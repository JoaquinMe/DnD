...
While wearing the Sage's Signet, you can cast the [Aura of Vitality](z_compendium/spells/aura-of-vitality.md) and [Mass Cure Wounds](z_compendium/spells/mass-cure-wounds.md) once each from the ring using your Intelligence as the spellcasting ability. Once you cast each spell from the ring, the ring can't cast the spell again until the next dawn.
