...
While wearing the Sage's Signet, you can cast the [Fear](z_compendium/spells/fear.md) and [Hex](z_compendium/spells/hex.md) once each from the ring using your Intelligence as the spellcasting ability. Once you cast each spell from the ring, the ring can't cast the spell again until the next dawn.
