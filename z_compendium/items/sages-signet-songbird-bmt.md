...
While wearing the Sage's Signet, you can cast the [Charm Person](z_compendium/spells/charm-person.md) and [Hypnotic Pattern](z_compendium/spells/hypnotic-pattern.md) once each from the ring using your Intelligence as the spellcasting ability. Once you cast each spell from the ring, the ring can't cast the spell again until the next dawn.
