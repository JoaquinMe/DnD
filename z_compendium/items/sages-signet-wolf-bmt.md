...
While wearing the Sage's Signet, you can cast the [Freedom of Movement](z_compendium/spells/freedom-of-movement.md) and [Pass without Trace](z_compendium/spells/pass-without-trace.md) once each from the ring using your Intelligence as the spellcasting ability. Once you cast each spell from the ring, the ring can't cast the spell again until the next dawn.
