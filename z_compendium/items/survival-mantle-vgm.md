...
A creature wearing a survival mantle can breathe normally in any environment (including a vacuum) and has advantage on saving throws against harmful gases (such as those created by a [cloudkill](z_compendium/spells/cloudkill.md) spell, a [stinking cloud](z_compendium/spells/stinking-cloud.md) spell, inhaled poisons, and the breath weapons of some dragons).
