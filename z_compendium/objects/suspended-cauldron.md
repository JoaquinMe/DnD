...
Cauldrons can be filled with other liquids, such as acid or [green slime](z_compendium/traps-hazards/green-slime.md), with different effects.

```ad-statblock
title: Suspended Cauldron
![](z_compendium/objects/token/suspended-cauldron.png#token)
*Large Siege weapon*
