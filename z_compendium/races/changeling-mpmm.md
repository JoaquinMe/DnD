...
Thanks to your connection to the fey realm, you gain proficiency with two of the following skills of your choice: [Deception](z_compendium/rules/skills.md#Deception), [Insight](z_compendium/rules/skills.md#Insight), [Intimidation](z_compendium/rules/skills.md#Intimidation), [Performance](z_compendium/rules/skills.md#Performance), or [Persuasion](z_compendium/rules/skills.md#Persuasion).
