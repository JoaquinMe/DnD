...
You have proficiency with the [battleaxe](z_compendium/items/battleaxe.md), [handaxe](z_compendium/items/handaxe.md), [light hammer](z_compendium/items/light-hammer.md), and [warhammer](z_compendium/items/warhammer.md).

### Tool Proficiency

You gain proficiency with the artisan's tools of your choice: [Smith's tools](z_compendium/items/smiths-tools.md), [brewer's supplies](z_compendium/items/brewers-supplies.md), or [mason's tools](z_compendium/items/masons-tools.md).

### Stonecunning

Whenever you make an Intelligence ([History](z_compendium/rules/skills.md#History)) check related to the origin of stonework, you are considered proficient in the [History](z_compendium/rules/skills.md#History) skill and add double your proficiency bonus to the check, instead of your normal proficiency bonus.
