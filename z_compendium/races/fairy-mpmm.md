...
You know the [druidcraft](z_compendium/spells/druidcraft.md) cantrip. Starting at 3rd level, you can cast the [faerie fire](z_compendium/spells/faerie-fire.md) spell with this trait. Starting at 5th level, you can also cast the [enlarge/reduce](z_compendium/spells/enlarge-reduce.md) spell with this trait. Once you cast [faerie fire](z_compendium/spells/faerie-fire.md) or [enlarge/reduce](z_compendium/spells/enlarge-reduce.md) with this trait, you can't cast that spell with it again until you finish a long rest. You can also cast either of those spells using any spell slots you have of the appropriate level.
