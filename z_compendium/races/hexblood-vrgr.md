...
- **Remote Viewing.** If you are within 10 miles of the token, you can enter a trance as an action. The trance lasts for 1 minute, but it ends early if you dismiss it (no action required) or are [incapacitated](z_compendium/rules/conditions.md#incapacitated). During this trance, you can see and hear from the token as if you were located where it is. While you are using your senses at the token's location, you are [blinded](z_compendium/rules/conditions.md#blinded) and [deafened](z_compendium/rules/conditions.md#deafened) in regard to your own surroundings. When the trance ends, the token is harmlessly destroyed.  

Once you create a token using this feature, you can't do so again until you finish a long rest, at which point your missing part regrows.

### Hex Magic

You can cast the [disguise self](z_compendium/spells/disguise-self.md) and [hex](z_compendium/spells/hex.md) spells with this trait. Once you cast either of these spells with this trait, you can't cast that spell with it again until you finish a long rest. You can also cast these spells using any spell slots you have.
