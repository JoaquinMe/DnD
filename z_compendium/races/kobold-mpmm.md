...
- **Craftiness.** You have proficiency in one of the following skills of your choice: [Arcana](z_compendium/rules/skills.md#Arcana), [Investigation](z_compendium/rules/skills.md#Investigation), [Medicine](z_compendium/rules/skills.md#Medicine), [Sleight of Hand](z_compendium/rules/skills.md#Sleight%20of%20Hand), or [Survival](z_compendium/rules/skills.md#Survival).  
- **Defiance.** You have advantage on saving throws to avoid or end the [frightened](z_compendium/rules/conditions.md#frightened) condition on yourself.  
