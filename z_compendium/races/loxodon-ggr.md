...
You have advantage on saving throws against being [charmed](z_compendium/rules/conditions.md#charmed) or [frightened](z_compendium/rules/conditions.md#frightened).
...
Thanks to your sensitive trunk, you have advantage on Wisdom ([Perception](z_compendium/rules/skills.md#Perception)), Wisdom ([Survival](z_compendium/rules/skills.md#Survival)), and Intelligence ([Investigation](z_compendium/rules/skills.md#Investigation)) checks that involve smell.
