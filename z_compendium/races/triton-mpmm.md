...
You can cast [fog cloud](z_compendium/spells/fog-cloud.md) with this trait. Starting at 3rd level, you can cast the [gust of wind](z_compendium/spells/gust-of-wind.md) spell with this trait. Starting at 5th level, you can also cast the [water walk](z_compendium/spells/water-walk.md) spell with it. Once you cast any of these spells with this trait, you can't cast that spell with it again until you finish a long rest. You can also cast these spells using any spell slots you have of the appropriate level.
