...
You are proficient in one of the following skills of your choice: [Arcana](z_compendium/rules/skills.md#Arcana), [History](z_compendium/rules/skills.md#History), [Investigation](z_compendium/rules/skills.md#Investigation), [Medicine](z_compendium/rules/skills.md#Medicine), [Performance](z_compendium/rules/skills.md#Performance), or [Sleight of Hand](z_compendium/rules/skills.md#Sleight%20of%20Hand). You are also proficient with one "tool" of your choice.
