...
To attempt a crime, the character makes three checks: Dexterity ([Stealth](z_compendium/rules/skills.md#Stealth)), Dexterity using [thieves' tools](z_compendium/items/thieves-tools.md), and the player's choice of Intelligence ([Investigation](z_compendium/rules/skills.md#Investigation)), Wisdom ([Perception](z_compendium/rules/skills.md#Perception)), or Charisma ([Deception](z_compendium/rules/skills.md#Deception)).
...
![Crime; Loot Value](z_compendium/tables/crime-loot-value-xge.md)
...
![Crime Complications](z_compendium/tables/crime-complications-xge.md)