...
The character makes three checks: Wisdom ([Insight](z_compendium/rules/skills.md#Insight)), Charisma ([Deception](z_compendium/rules/skills.md#Deception)), and Charisma ([Intimidation](z_compendium/rules/skills.md#Intimidation)). If the character has proficiency with an appropriate [gaming set](z_compendium/items/gaming-set.md), that tool proficiency can replace the relevant skill in any of the checks. The DC for each of the checks is `5 + 2d10`; generate a separate DC for each one. Consult the Gambling Results table to see how the character did.

![Gambling Results](z_compendium/tables/gambling-results-xge.md)
...
![Gambling Complications](z_compendium/tables/gambling-complications-xge.md)