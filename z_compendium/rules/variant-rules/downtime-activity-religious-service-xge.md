...
At the end of the required time, the character chooses to make either an Intelligence ([Religion](z_compendium/rules/skills.md#Religion)) check or a Charisma ([Persuasion](z_compendium/rules/skills.md#Persuasion)) check. The total of the check determines the benefits of service, as shown on the Religious Service table.

![Religious Service](z_compendium/tables/religious-service-xge.md)
...
![Religious Service Complications](z_compendium/tables/religious-service-complications-xge.md)