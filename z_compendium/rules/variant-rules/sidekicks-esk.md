...
- [Spellcaster](z_compendium/bestiary/humanoid/spellcaster-esk.md)  
- [Expert](z_compendium/bestiary/humanoid/expert-esk.md)  
- [Warrior](z_compendium/bestiary/humanoid/warrior-esk.md)  
...
|-------|------------|--------------|
| 2nd | 16 (`3d8 + 3`) | **Cunning Action.** On the expert's turn in combat, it can take the [Dash](z_compendium/rules/actions.md#Dash), Disengage, or [Hide](z_compendium/rules/actions.md#Hide) action as a bonus action. |
...
| 4th | 27 (`5d8 + 5`) | **Ability Score Improvement.** The expert's Dex. score increases by 2, raising the modifier by 1, so increase the following numbers by 1: the Dex. saving throw bonus; the [Acrobatics](z_compendium/rules/skills.md#Acrobatics), [Sleight of Hand](z_compendium/rules/skills.md#Sleight%20of%20Hand), and [Stealth](z_compendium/rules/skills.md#Stealth) bonuses; and the bonuses to hit and damage of the expert's weapon attacks. |
...
| 6th | 38 (`7d8 + 7`) | **Extra Attack.** The expert can attack twice, instead of once, whenever it takes the [Attack](z_compendium/rules/actions.md#Attack) action on its turn. |
^experts-beyond-1st-level
...
| Level | Hit Points | New Features |
|-------|------------|--------------|
| 2nd | 13 (`3d8`) | **Spellcasting.** The spellcaster learns another 1st-level spell: [bless](z_compendium/spells/bless.md) (healer) or [burning hands](z_compendium/spells/burning-hands.md) (mage). |
| 3rd | 18 (`4d8`) | **Spellcasting.** The spellcaster gains one 1st-level spell slot. The spellcaster also learns another 1st-level spell: [shield of faith](z_compendium/spells/shield-of-faith.md) (healer) or [shield](z_compendium/spells/shield.md) (mage). |
| 4th | 22 (`5d8`) | **Ability Score Improvement.** The spellcaster's Int. (mage) or Wis. (healer) score increases by 2, raising the modifier by 1, so increase the following numbers by 1: the spellcaster's spell save DC and the bonus to hit of spell attacks, the bonuses in the Skills entry of the mage, the Wisdom saving throw bonus of the healer, and the passive [Perception](z_compendium/rules/skills.md#Perception) of the healer. Spellcasting. The spellcaster learns another cantrip: [resistance](z_compendium/spells/resistance.md) (healer) or [mage hand](z_compendium/spells/mage-hand.md) (mage). |
| 5th | 27 (`6d8`) | **.** **Proficiency Bonus.** The spellcaster's proficiency bonus increases by 1, so make the following changes in the stat block: increase the bonuses in the Saving Throws and Skills entries by 1, and increase the bonuses to hit of its spell and weapon attacks by 1.<br /><br />**Spellcasting.** The spellcaster gains one 1st-level spell slot and two 2nd-level spell slots. The spellcaster also learns one 2nd-level spell: [aid](z_compendium/spells/aid.md) (healer) or [invisibility](z_compendium/spells/invisibility.md) (mage) |
...
| 4th | 32 (`5d8 + 10`) | **Ability Score Improvement.** The warrior's Str. score increases by 2, raising the modifier by 1, so increase the warrior's [Athletics](z_compendium/rules/skills.md#Athletics) bonus by 1, and increase the bonuses to hit and damage of the warrior's melee weapon attack by 1. |
| 5th | 39 (`6d8 + 12`) | **Proficiency Bonus.** The warrior's proficiency bonus increases by 1, so make the following changes in the stat block: increase the bonuses in the Saving Throws and Skills entries by 1, increase the passive [Perception](z_compendium/rules/skills.md#Perception) by 1, and increase the bonuses to hit of the weapon attacks by 1. |
| 6th | 45 (`7d8 + 14`) | **Extra Attack.** The warrior can attack twice, instead of once, whenever it takes the [Attack](z_compendium/rules/actions.md#Attack) action on its turn. |
^warriors-beyond-1st-level