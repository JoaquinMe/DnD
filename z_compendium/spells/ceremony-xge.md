...
You touch one willing creature whose alignment has changed, and you make a DC 20 Wisdom ([Insight](z_compendium/rules/skills.md#Insight)) check. On a successful check, you restore the target to its original alignment.

## Bless Water

You touch one [vial](z_compendium/items/vial.md) of water and cause it to become [holy water](z_compendium/items/holy-water-flask.md).
...
You touch one corpse, and for the next 7 days, the target can't become undead by any means short of a [wish](z_compendium/spells/wish.md) spell.
