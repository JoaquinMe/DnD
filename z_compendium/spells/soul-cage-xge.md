...
A creature that can see the sensor (such as one using [see invisibility](z_compendium/spells/see-invisibility.md) or [truesight](z_compendium/rules/senses.md#truesight)) sees a translucent image of the tormented humanoid whose soul you caged.
