...
|-----------|---------------|
| 1 | You were [charmed](z_compendium/rules/conditions.md#charmed) or [frightened](z_compendium/rules/conditions.md#frightened) by a spell. |
...
| 7 | You turned [invisible](z_compendium/rules/conditions.md#invisible) for a time. |
